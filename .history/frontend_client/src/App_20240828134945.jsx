...
import discount_codes from "@/pages/bookingHelper/discount_codes";
...
function App() {
  ...
  useEffect(() => {
    ...
    if (discountqueryParams.get('referral') === 'friendsfrombespoke') {
  ...
  return (
    <>  
        ...
        {isRefClient && <BespokeModal open={isRefClient} onClose={handleCloseModal} />}
    </>
  );
}
