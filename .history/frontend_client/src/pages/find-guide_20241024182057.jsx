            ...
            <>
              <div className="flex justify-center text-center">
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div className="w-48 h-8 sm:w-48 sm:h-8 bg-gray-200 rounded-2xl flex items-center transition-all duration-300">
                    <div
                      className={`w-full h-full p-2 flex justify-center text-xs sm:text-md font-semibold items-center transition-all duration-400 ${
                        isGuideForm ? 'bg-indigo-800 text-white' : 'bg-gray-300 text-gray-900'
                      } rounded-2xl`}
                    >
                      Tour
                    </div>
                    <div
                      className={`w-full h-full p-2 flex justify-center text-sm sm:text-md font-semibold items-center transition-all duration-400 ${
                        isGuideForm ? 'bg-gray-300 text-gray-900' : 'bg-indigo-800 text-white'
                      } rounded-2xl`}
                    >
                      Video Chat
                    </div>
