  ...
  return ReactDOM.createPortal(
    ...
    >
      ...
      >
        ...
        <Typography className='px-4 font-bold text-gray-700'>$150</Typography>
        <div className="p-4">
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-sm ${bookingData.student_athlete ? 'text-gray-200' : 'text-gray-500'}`}>Learn about balancing academics and athletics.</p>
