                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-sm ${bookingData.greek_life ? 'text-gray-200' : 'text-gray-500'}`}>Learn about the greek life on campus, the rush process, and potentially even see the g.</p>
