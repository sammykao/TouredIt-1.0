          ...
          showMap && (
            <div className="bg-white mt-40 px-6 py-6 rounded-lg mx-auto">
              <div className="w-full mb-6 text-center">
                  <h1 className="text-2xl sm:text-4xl leading-7 text-black mb-4">Thanks for submitting an itinerary request </h1>
                  <TripMap schools={schools} />
                  <h1 className="text-sm sm:text-lg text-black mt-2">Checkout your spots on the map while we get back to you.</h1>
