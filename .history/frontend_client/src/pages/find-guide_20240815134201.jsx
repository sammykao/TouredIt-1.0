  ...
  return (
    <div className="relative isolate px-6 pt-14 lg:px-8 min-h-screen pb-24 bg-gray-500">
      ...
      <div class="flex flex-col items-center mt-36">
        <img className='mb-4' src={logo} alt="Logo"></img>
      ...
      {guides.length > 0 ? (
        <>
          <div className="mb-4 bg-white max-w-md mx-auto p-4 rounded-xl">
            ...
            <div className="mt-4">
              <Typography variant="medium bold" className="text-center font-medium text-gray-700 mb-2">
                Icons:
              </Typography>
              <div className="flex items-center space-x-4">
                <div className="flex items-center">
                  <SportsBarIcon className="text-[#ca8a04] mr-3" />
                  <Typography variant="small" className="text-gray-700"> Greek Life</Typography>
                </div>
                <div className="flex items-center">
                  <EmojiEventsIcon className="text-[#eab308] mr-3" />
                  <Typography variant="small" className="text-gray-700">Student Athlete</Typography>
                </div>
                <div className="flex items-center">
                  <WorkIcon className="text-[#4d7c0f] mr-3" />
