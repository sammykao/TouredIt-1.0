              ...
              <div className="lg:pr-4">
                <div className="lg:max-w-lg">
                  ...
                  <p className="mt-6 text-xl leading-8 text-gray-700">
                    ...
                    is yours and the guide is meant to serve all your pre-college needs. Don't be afraid to ask non-traditional questions on 
                    your call or tour. The last thing we want is for the tour to be like an admissions tour, or the call to be like a classroom zoom.
                  </p>
                </div>
              </div>
            </div>
