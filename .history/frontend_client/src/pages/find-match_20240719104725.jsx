...
const FindMatch = () => {
  ...
  return (
      <div className="bg-gray-100/50 px-4 py-4 items-center overflow-hidden m-24 shadow rounded-lg max-w-4xl mx-auto">
        <h2 className="text-3xl align-center font-bold mb-4">Select Your School</h2>
        <div className="mb-4">
          <input
            type="text"
        ...
        <button
          ...
          size="xs"
          variant="gradient"
          className="justify-center bg-blue-400 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded focus:outline-none focus:shadow-outline"
        >
          Find a match
        </button>
      </div>
