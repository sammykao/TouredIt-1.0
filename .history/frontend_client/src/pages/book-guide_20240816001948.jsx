                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-md ${bookingData.greek_life ? 'text-gray-200' : 'text-gray-700'}`}>Learn about the greek life on campus, the rush process, and potentially even see the guide's respective frat or sorority house(s).</p>
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-md ${bookingData.student_athlete ? 'text-gray-200' : 'text-gray-700'}`}>Learn about the recruiting process, balancing academics and athletics, and potentially even see athlete exclusive facilities.</p>
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-md ${bookingData.paid_internship ? 'text-gray-200' : 'text-gray-500'}`}>Your guide has noted paid internship experience. Learn about the internship recruitment process, how to get internships as a college student, 
