  ...
  return (
    <div className="relative isolate px-3 pb-20 pt-14 lg:px-8 min-h-screen bg-gray-500">
      <div id="join-flow" className="mt-36 flex-col justify-center align-center mx-auto">
        <h1 className="bg-gray-300 text-2xl text-center font-bold mb-8 tracking-tight text-blue-900 sm:text-4xl">
          Welcome to TouredIt Video!
        </h1>
        <div 
          id="video-container" 
          ref={videoContainerRef} 
          style={{ width: '100%' }} 
        />  {/* Use ref to target the container */}
      </div>
      ...
      <style jsx>{`
        #video-container {
          height: 800px;  /* Default for large screens */
          border-radius: 10px;
        }
        ...
        @media (max-width: 480px) {
          #video-container {
            height: 600px;  /* Further adjust height for very small screens */
          }
        }
      `}</style>
    </div>
