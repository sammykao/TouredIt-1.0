                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-sm ${bookingData.paid_internship ? 'text-gray-200' : 'text-gray-500'}`}>Your guide has noted paid internship experience. Gain insights on the internship recruitment process, .</p>
