import { BriefcaseIcon, ServerIcon, UserPlusIcon } from '@heroicons/react/24/solid'
  ...
  return (
    <>
      <div className="relative isolate px-6 pb-20 pt-14 lg:px-8 min-h-screen bg-gray-500">
        ...
        <div className="py-24 mt-12 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:text-center">
              <h2 className="text-base font-semibold leading-7 text-blue-900">Why TouredIt? </h2>
              <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Personalize your college search</p>
              <p className="mt-6 text-lg leading-8 text-gray-800">Choosing where you want to attend school is harder than it has ever been. 
            ...
            <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
              <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                <div className="relative pl-16">
                  ...
                  <dd className="mt-2 text-base leading-7 text-gray-800">Personalize your college tour by hand-picking your guide. 
                ...
                <div className="relative pl-16">
                  ...
                  <dd className="mt-2 text-base leading-7 text-gray-800">TouredIt tour guides aren't just tour guides — they are 
                ...
                <div className="relative pl-16">
                  ...
                  <dd className="mt-2 text-base leading-7 text-gray-800">On your call or tour, learn more about the application process and what the student did to get in the school.</dd>
                </div>
              </dl>
            </div>
          </div>
