            ...
            {isEditing ? (
              <form className="space-y-6 sm:py-6 sm:px-6">
                ...
                <div className="flex justify-end space-x-4">
                  <Button variant="text" color="blue-gray" className="px-2 py-2 sm:px-4" size="md" onClick={() => setIsEditing(false)}>
                    Cancel
                  </Button>
                  <Button variant="gradient" className="px-2 py-2 sm:px-4s" color="green" size="md" onClick={handleEditSave}>
                    Save
                  </Button>
                </div>
              </form>
