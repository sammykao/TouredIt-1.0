                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-sm m ${bookingData.paid_internship ? 'text-gray-200' : 'text-gray-900'}`}>Learn about the internship recruitment process, how to get internships as a college student, 
