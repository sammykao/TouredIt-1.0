                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-sm my-2 ${bookingData.greek_life ? 'text-gray-200' : 'text-gray-900'}`}>Learn about the greek life on campus, the rush process, and potentially even see the guide's respective frat or sorority house(s) (Guide's Choice).</p>
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-sm my-2 ${bookingData.student_athlete ? 'text-gray-200' : 'text-gray-900'}`}>Learn about the recruiting process, balancing academics and athletics, and potentially even see athlete exclusive facilities (Guide's Choice).</p>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-sm my-2 ${bookingData.paid_internship ? 'text-gray-200' : 'text-gray-900'}`}>Learn about the internship recruitment process, how to get internships as a college student, 
                          and ask any tips for resume content or extra-curricular activities.</p>
                        <p className={`text-sm font-bold ${bookingData.paid_internship ? 'text-white' : 'text-gray-700'}`}>+$50</p>
                      </div>
                    </div>
                  </div>
                  <Typography className='text-md text-black'>For any of the package add-ons your guide will decide whether they are willing to do each. They will reach out individually to discuss and arrange possible logistics, then our team will confirm with both parties to confirm logistics and prices. </Typography>
                  </>
                )}
              </div>
            </>
