...
const FindMatch = () => {
  ...
  return (
      <div className="bg-gray-100/50 px-4 py-4 overflow-hidden m-24 shadow rounded-lg flex flex-col items-center max-w-4xl mx-auto">
        ...
        <div className="w-full mb-4">
          <input
            ...
            className="w-full p-2 border border-gray-300 rounded text-3l focus:border-gray-900"
