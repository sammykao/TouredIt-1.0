          ...
          <div className="flex justify-center mt-4 mb-12">
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={toggleForm}
              />
              <div className="w-60 h-10 sm:w-80 sm:h-12 bg-gray-200 rounded-3xl flex items-center transition-all duration-300">
                <div
                  className={`w-full h-full flex justify-center text-sm sm:text-md font-semibold items-center transition-all duration-400 ${
                    showForm ? 'bg-indigo-800 text-white' : 'bg-gray-200 text-gray-900'
                  } rounded-3xl`}
                >
                  Custom Form
                </div>
                <div
                  className={`w-full h-full flex justify-center text-sm sm:text-md font-semibold items-center transition-all duration-400 ${
                    showForm ? 'bg-gray-200 text-gray-900' : 'bg-indigo-800 text-white'
                  } rounded-3xl`}
                >
                  Popular Students
                </div>
