...
export function SignUp() {
  ...
  return (
    <div className="relative isolate px-6 pt-20 lg:px-8 min-h-screen pb-24 bg-gray-500">
        <section className="m-8 flex bg-white">
            ...
            {!isVerifying ? (
              ...
              <form onSubmit={handleVerification} className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
                ...
                <Typography variant="paragraph" className="text-center text-blue-gray-500 font-medium mt-4">
                  ...
                  <Button className="text-gray-900 ml-2" color="light-blue" onClick={handleResendCode}>Resend Code</Button>
                </Typography>
              </form>
            )}
          </div>
