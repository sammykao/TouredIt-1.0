                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-sm ${bookingData.student_athlete ? 'text-gray-200' : 'text-gray-900'}`}>Learn about the recruiting process, balancing academics and athletics, and potentially even see athlete exclusive facilities.</p>
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-sm my-2=3 ${bookingData.paid_internship ? 'text-gray-200' : 'text-gray-900'}`}>Learn about the internship recruitment process, how to get internships as a college student, 
