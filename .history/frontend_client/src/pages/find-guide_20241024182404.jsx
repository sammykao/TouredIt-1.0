            ...
            <>
              <div className="flex justify-center text-center">
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div className="w-48 h-8 sm:w-48 sm:h-8 bg-white-200 rounded-2xl flex items-center transition-all duration-300">
                    <div
                      className={`w-full h-full p-2 flex justify-center text-xs font-semibold items-center transition-all duration-400 ${
                        isGuideForm ? 'bg-blue-600 text-white' : 'bg-white-300 text-gray-900'
                      } rounded-2xl`}
                    >
                      Tour
                    </div>
                    <div
                      className={`w-full h-full p-2 flex justify-center text-xs font-semibold items-center transition-all duration-400 ${
                        isGuideForm ? 'bg-white-300 text-gray-900' : 'bg-blue-600 text-white'
                      } rounded-2xl`}
                    >
                      Video Chat
                    </div>
