...
import { Icon1, Icon2, Icon3 } from '@material-tailwind/react'; // Replace with actual icons
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
              ...
              <div className="p-6 bg-blue-500 text-white rounded-lg shadow-lg">
                <Icon1 className="text-5xl mb-4 mx-auto" />
              ...
              <div className="p-6 bg-green-500 text-white rounded-lg shadow-lg">
                <Icon2 className="text-5xl mb-4 mx-auto" />
                <Typography variant="h5" className="font-bold">
                  Step 2: Find a Guide
                </Typography>
                <Typography className="mt-2">
                  Connect with a student guide who will show you around.
                </Typography>
              </div>

              <div className="p-6 bg-red-500 text-white rounded-lg shadow-lg">
                <Icon3 className="text-5xl mb-4 mx-auto" />
                <Typography variant="h5" className="font-bold">
