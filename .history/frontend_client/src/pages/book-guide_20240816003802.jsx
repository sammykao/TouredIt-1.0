            ...
            <>
              ...
              <div className="mb-4 space-y-4">
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-sm my-2 ${bookingData.greek_life ? 'text-gray-200' : 'text-gray-900'}`}>Learn about the greek life on campus, 
                          the rush process, and potentially even see the guide's respective frat or sorority house(s) (Guide's Choice).</p>
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-sm my-2 ${bookingData.student_athlete ? 'text-gray-200' : 'text-gray-900'}`}>Learn about the recruiting process, 
                          balancing academics and athletics, and potentially even see athlete exclusive facilities (Guide's Choice).</p>
                ...
                {guideInfo?.paid_internship && (
                  ...
                  <Typography className='text-sm text-gray-700'>For any of the package add-ons, your guide will decide whether they are willing to do each. 
                    They will reach out individually to discuss and arrange possible logistics. Then, our team will confirm with both parties to confirm logistics and prices. </Typography>
                  </>
                )}
              </div>
            </>
