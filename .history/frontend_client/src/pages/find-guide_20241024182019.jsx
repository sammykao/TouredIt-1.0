            ...
            <>
              <div className="flex justify-center text-center">
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div className="w-42 h-8 sm:w-42 sm:h-8 bg-gray-200 rounded-2xl flex items-center transition-all duration-300">
                    <div
                    ...
                    <div
                      className={`w-full h-full p-1 flex justify-center text-sm sm:text-md font-semibold items-center transition-all duration-400 ${
