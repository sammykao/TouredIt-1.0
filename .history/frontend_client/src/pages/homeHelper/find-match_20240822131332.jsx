...
const FindMatch = () => {
  ...
  return (
      <div className="px-4 py-4 overflow-hidden shadow bg-gradient-to-r from-blue-500 to-gray-600 min-w-screen m-24 mb-32 rounded-lg flex flex-col items-center max-w-4xl mx-auto">
