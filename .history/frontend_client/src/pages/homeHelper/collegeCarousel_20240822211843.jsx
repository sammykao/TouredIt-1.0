          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 w-full">
              ...
              <div className="flex flex-col items-center p-4 bg-gray-100 rounded-lg shadow-inner">
                ...
                <p className="text-lg text-gray-800">{info.location}</p>
              </div>

              {/* Undergraduate Population Section */}
              <div className="flex flex-col items-center p-4 bg-gray-100 rounded-lg shadow-inner">
                <SchoolIcon className="text-purple-500 text-3xl mb-2" />
              ...
              <div className="flex flex-col items-center p-4 bg-gray-100 rounded-lg shadow-inner">
                <AttachMoneyIcon className="text-yellow-500 text-3xl mb-2" />
              ...
              <div className="flex flex-col items-center p-4 bg-gray-100 rounded-lg shadow-inner">
                <AttachMoneyIcon className="text-red-500 text-3xl mb-2" />
                <p className="text-sm text-gray-500">Out-of-State Tuition</p>
