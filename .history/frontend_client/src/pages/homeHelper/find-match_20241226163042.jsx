    ...
    <div className="px-4 py-4 overflow-hidden min-w-screen mt-20 mb-16 rounded-3xl flex flex-col items-center max-w-4xl mx-auto">
      <div className="w-full mb-4">
        <input
          ...
          className="w-full rounded-xl text-lg md:text-2xl p-4 lg:p-6 shadow-lg rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
