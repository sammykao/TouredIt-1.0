      ...
      <div className="w-full mb-4">
        <div className="flex items-center bg-white rounded-full shadow-lg border border-gray-300 focus-within:ring-2 focus-within:ring-blue-500 overflow-hidden">
          <input
            ...
            className="flex-grow text-lg p-4 focus:outline-none bg-white text-lg md:text-xl p-2 lg:p-4"
            placeholder="Search for a school..."
          />
          <button
            onClick={handleValidation}
            className="text-lg md:text-xl font-semibold py-4 px-6 bg-blue-600 text-white hover:bg-blue-800 focus:outline-none"
          >
            Search
          </button>
        </div>
