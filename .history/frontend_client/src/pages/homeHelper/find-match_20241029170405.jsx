...
const FindMatch = () => {
  ...
  if (error) {
    return (
      <div className="flex items-center mt-16 mb-32 justify-center px-6 pt-14">
        <Typography
          variant="h5"
          color="blue-gray"
  ...
  return (
    <div className="px-4 py-4 overflow-hidden shadow bg-gradient-to-r from-blue-200 to-indigo-300 min-w-screen mt-12 mb-16 rounded-3xl flex flex-col items-center max-w-4xl mx-auto">
