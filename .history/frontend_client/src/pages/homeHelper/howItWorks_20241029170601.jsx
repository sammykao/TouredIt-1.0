...
export const HowItWorks = () => {
    return (
        <section className="py-12 rounded-xl mb-16">
            <div className="container mx-auto">
                <Typography
                    variant="h1"
                    color="blue-gray"
                    className="text-center mb-10 text-6xl font-bold"
                >
                    How It Works
                </Typography>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 text-center">
                    ...
                    <div className="gradient-border">
                        <div className="h-full p-6 bg-blue-400 text-white rounded-lg shadow-lg">
                    ...
                    <div className="gradient-border">
                        <div className="h-full p-6 bg-blue-700 text-white rounded-lg shadow-lg">
                    ...
                    <div className="gradient-border">
                        <div className="h-full p-6 bg-blue-900 text-white rounded-lg shadow-lg">
