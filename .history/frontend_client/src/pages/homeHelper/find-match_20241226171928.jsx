      ...
      <div className="w-full mb-4">
        <div className="flex items-center bg-white rounded-full shadow-lg border border-gray-300   focus focus-within:ring-blue-500 overflow-hidden">
          ...
          <button
            ...
            className="flex items-center justify-center text-xl md:text-2xl font-semibold px-6 py-6 bg-blue-600 text-white hover:bg-blue-700"
          >
            <SearchIcon className="h-6 w-6 md:h-12 md:w-12" />
          </button>
        </div>
        <div>
