...
const FindMatch = () => {
  ...
  const currentVersion = "1.1"; // Update this with each deployment
  ...
  return (
    <div className="px-4 py-4 overflow-hidden min-w-screen mt-12 mb-24 rounded-3xl flex flex-col items-center max-w-4xl mx-auto">
      <div className="w-full mb-4">
        <input
          type="text"
          value={selectedSchool}
          onChange={handleSchoolChange}  // Filter schools as the user types
          className="w-full rounded-full text-lg md:text-2xl p-4 lg:p-5 shadow-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
