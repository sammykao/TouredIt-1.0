...
const FindMatch = () => {
  ...
  return (
      <div className='text-center items-center m-12'>
        <h2 className="sm:texl-3xl lg:text-5xl font-bold mb-4">Select Your School</h2>
        <div className="px-4 py-4 overflow-hidden shadow bg-gray-100/50 mb-32 rounded-lg flex flex-col items-center max-w-4xl mx-auto">
