  ...
  return (
    ...
    >
      <div className="w-full mb-4 relative">
        <div className="flex items-center rounded-full shadow-lg border border-gray-300 focus-within:ring-2 focus-within:ring-blue-500">
          <input
            type="text"
            value={selectedSchool}
            onChange={handleSchoolChange}
            className="flex-grow rounded-l-full text-lg p-4 focus:outline-none"
            placeholder="Search for a school..."
          />
          <button
            onClick={handleValidation}
            className="bg-blue-600 hover:bg-blue-900 text-white font-semibold py-2 px-6 rounded-full ml-2"
          >
            Search
          </button>
        </div>
