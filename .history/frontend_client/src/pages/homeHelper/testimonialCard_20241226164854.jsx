...
export function TestimonialCard({ img, client, title, clientInfo }) {
  return (
    <Card shadow={false} className="bg-gray-100/50 h-[24rem] rounded-2xl p-4 sm:p-6">
...
export const testimonials = [
    ...
    },
    {
      ...
      We got much better access to the insides of buildings being with a student 1-on-1 rather \
