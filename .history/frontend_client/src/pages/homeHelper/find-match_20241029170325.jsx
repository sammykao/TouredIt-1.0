...
const FindMatch = () => {
  ...
  return (
    <div className="px-4 py-4 overflow-hidden shadow bg-gradient-to-r from-blue-200 to-indigo-300 min-w-screen mt-12 mb-16 mb-32 rounded-3xl flex flex-col items-center max-w-4xl mx-auto">
