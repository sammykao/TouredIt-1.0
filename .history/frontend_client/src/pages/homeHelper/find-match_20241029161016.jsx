...
const FindMatch = () => {
  ...
  uconst currentVersion = "1.0"; // Update this with each deployment
  ...
  if (error) {
    return (
      <div className="flex items-center mb-32 justify-center px-6 pt-14">
        <Typography
          variant="h5"
          color="blue-gray"
  ...
  return (
    <div className="px-4 py-4 overflow-hidden shadow bg-gradient-to-r from-blue-200 to-indigo-300 min-w-screen mb-32 rounded-3xl flex flex-col items-center max-w-4xl mx-auto">
      <h2 className="text-2xl md:text-4xl font-bold mb-4">Select Your School</h2>
      <div className="w-full mb-4">
        <input
          type="text"
          value={selectedSchool}
          onChange={handleSchoolChange}  // Filter schools as the user types
          className="w-full text-sm md:text-lg p-2 lg:p-3 shadow-lg rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
