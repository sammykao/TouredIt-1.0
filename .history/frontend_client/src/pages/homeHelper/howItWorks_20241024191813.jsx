            ...
            <div className="container mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
                    <style jsx>{`
                        ...
                        background-size: 500% 200%; /* This makes the gradient large enough to animate */
                        animation: gradient-border 10s linear infinite alternate; /* Animation for moving gradient */
                        }
