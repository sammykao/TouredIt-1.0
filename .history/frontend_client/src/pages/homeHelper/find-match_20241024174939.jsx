...
const FindMatch = () => {
  ...
  if (loading) {
    return (
      <div className="flex mb-24 items-center justify-center px-6 pt-14">
        <div
  ...
  if (error) {
    return (
      <div className="flex items-center mb-4s2 justify-center px-6 pt-14">
        <Typography
          variant="h5"
          color="blue-gray"
  ...
  return (
    <div className="px-4 py-4 overflow-hidden shadow bg-gradient-to-r from-blue-200 to-indigo-300 min-w-screen mb-42 rounded-3xl flex flex-col items-center max-w-4xl mx-auto">
