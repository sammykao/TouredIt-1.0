        ...
        renderArrowPrev={(onClickHandler, hasPrev, label) =>
          hasPrev && (
            <button
              ...
              title={label}
              className="absolute top-1/2 transform -translate-y-1/2 left-0 bg-black bg-opacity-70 hover:bg-opacity-90 rounded-full"
            >
              &lt;
            </button>
          )
        ...
        renderArrowNext={(onClickHandler, hasNext, label) =>
          hasNext && (
            <button
              ...
              onClick={onClickHandler}
              title={label}
              className="absolute top-1/2 transform p-12 -translate-y-1/2 right-0 bg-white bg-opacity-70 hover:bg-opacity-90 rounded-full"
            >
              &gt;
            </button>
          )
