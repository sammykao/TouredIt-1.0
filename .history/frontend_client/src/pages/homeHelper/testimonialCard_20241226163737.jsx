...
export function TestimonialCard({ img, client, title, clientInfo }) {
  return (
    <Card shadow={false} className="bg-gray-100/50 rounded-2xl h-[24rem] sm:h-[30rem] flex flex-col justify-between p-4 sm:p-6">
      <CardHeader color="transparent" floated={false} shadow={false}>
        <Typography
          color="blue-gray"
          className="mb- sm:mb-4 text-base sm:text-lg lg:text-2xl font-bold text-center"
        >
          &quot;{title}&quot;
        </Typography>
      </CardHeader>
...
export const testimonials = [
    ...
    {
      title: "It was great having a one on one tour to see what was important to us. \
      Also, we got much better access to the insides of buildings being with a student rather \
      than on the tour. Molly and Natalie were able to give us a driving tour which actually \
      worked out better for Clemson and Ga bc the campuses are so big. And Molly is hometown \
      friends with Brooke from Wake. Love it!",
      client: "Parthia Orth",
