...
const FindMatch = () => {
  ...
  return (
    <div className="flex justify-center items-center my-24 min-w-screen bg-gradient-to-r from-blue-500 to-indigo-600">
      <div className="w-full max-w-md md:max-w-lg lg:max-w-xl p-8 bg-white shadow-lg rounded-lg">
        ...
        <button
          ...
          className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
        >
          Find a match
        </button>
      </div>
