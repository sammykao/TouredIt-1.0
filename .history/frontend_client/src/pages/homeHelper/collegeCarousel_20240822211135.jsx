        ...
        renderArrowPrev={(onClickHandler, hasPrev, label) =>
          hasPrev && (
            <button
              ...
              title={label}
              className="absolute top-1/2 transform -translate-y-1/2 left-4 text-4xl bg-opacity-70 hover:bg-opacity-90 p-4 rounded-full z-10"
              style={{ zIndex: 10 }}
            >
              &lt;
            </button>
        ...
        renderArrowNext={(onClickHandler, hasNext, label) =>
          hasNext && (
            <button
              ...
              onClick={onClickHandler}
              title={label}
              className="absolute top-1/2 transform -translate-y-1/2 right-4 text-4xl bg-opacity-70 hover:bg-opacity-90 p-4 rounded-full z-10"
              style={{ zIndex: 10 }}
            >
              &gt;
            </button>
