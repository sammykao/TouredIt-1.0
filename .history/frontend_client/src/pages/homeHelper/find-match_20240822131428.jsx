...
const FindMatch = () => {
  ...
  return (
      <div className="px-4 py-4 overflow-hidden shadow bg-gradient-to-r from-blue-700 to-gray-600 min-w-screen m-24 mb-32 rounded-lg flex flex-col items-center max-w-4xl mx-auto">
        ...
        <div className="w-full mb-4">
          <input
            ...
            className="w-full text-lg p-3 shadow-lg rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-900"
