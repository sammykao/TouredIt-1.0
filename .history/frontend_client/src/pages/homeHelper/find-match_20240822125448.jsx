...
const FindMatch = () => {
  ...
  return (
      <div className="px-4 py-4 overflow-hidden shadow m-24 mb-32 rounded-lg flex flex-col items-center max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-4">Select Your School</h1>
