...
const FindMatch = () => {
  ...
  return (
      <div className='text-center items-center m-12'>
        <h2 className="text-3xl lg:text-4xl font-bold mb-4">Select Your School</h2>
        <div className="px-4 py-4 overflow-hidden shadow bg-gray-100/50 mb-20 rounded-lg flex flex-col items-center smmax-w-6xl lg:max-w-4xl mx-auto">
          <div className="w-full mb-4">
            <input
              type="text"
              value={selectedSchool}
              onChange={handleSchoolChange}
              className="w-full text-2xl p-2 shadow rounded focus:outline-none focus:bg-gray-400"
