  ...
  useEffect(() => {
    const fetchSchools = async () => {
      try {
        ...
        const duplicates = fetchedSchools.filter((item, index) => fetchedSchools.indexOf(item) !== index && fetchedSchools.indexOf(item) === index);

        // To get only unique duplicate names, you can use a Set
        const uniqueDuplicates = [...new Set(duplicates)];

        console.log(uniqueDuplicates);
        console.log(fetchedSchools.some((item, index) => fetchedSchools.indexOf(item) !== fetchedSchools.lastIndexOf(item)));
