  ...
  return (
    <Card shadow={false} className="bg-gray-100/50 rounded-2xl p-6">
      ...
      <CardBody className="px-4 py-0 flex flex-wrap-reverse gap-x-6 justify-between items-center">
        <div>
          <Typography variant="h6" className="text-center lg:text-left" color="blue-gray">
            {client}
          </Typography>
          <Typography
            variant="paragraph"
            className="text-center lg:text-left font-normal !text-gray-900"
          >
            {clientInfo}
          </Typography>
        </div>
        <img src={img} className="items-center lg:align-left max-w-[8rem] py-2 rounded-md" alt={client} />
      </CardBody>
    </Card>
  );
}
            ...
            >
              ...
              <CardBody className="items-center mx-auto py-2">
                <img
                  ...
                  className="max-w-[8rem] rounded-lg mx-auto my-6"
                  alt="spotify"
                />
