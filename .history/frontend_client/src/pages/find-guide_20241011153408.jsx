        ...
        <>
          <div className="flex justify-center mt-12">
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              />
              <div className="w-28 h-12 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 dark:bg-gray-700 peer-checked:bg-blue-600 transition-all duration-300">
                <span
                  className={`absolute text-sm font-medium transition-all duration-300 h-full flex justify-center items-center ${
                    showForm
                      ? 'left-0 w-1/2 text-white bg-blue-600 rounded-l-full'
                      : 'right-0 w-1/2 text-gray-900 bg-gray-300 rounded-r-full'
                  }`}
                >
                  {isGuideForm ? 'Custom Form' : 'Recent Popular TouredIt Guides'}
                </span>
              </div>
            </label>
          </div>
