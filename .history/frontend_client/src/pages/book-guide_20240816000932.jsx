                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-sm ${bookingData.student_athlete ? 'text-gray-200' : 'text-gray-500'}`}>Learn about the recruiting process, balancing academics and athletics, and potentially even .</p>
