      ...
      {guides.length > 0 ? (
              ...
              <div className="relative overflow-hidden transition-all duration-500 ease-in-out" style={{ minHeight: '400px' }}>
                ...
                {isGuideForm && (
                  <div>
                    ...
                    {showMap && (
                      <div className="w-full mt-8 mb-6 text-center bg-white rounded-xl px-4 py-8">
        ...
        <div className="bg-white px-6 py-6 m shadow rounded-lg border max-w-4xl mx-auto">
          <div className="w-full mb-6 text-center">
            <Typography className="font-bold text-md text-gray-900">*Please sign-in before submitting any form requests*</Typography>
