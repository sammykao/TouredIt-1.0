            ...
            <>
              ...
              <div className="mb-4 space-y-4">
                ...
                {guideInfo?.paid_internship && (
                  ...
                  <Typography className='text-md text-black'>For any of the package add-ons your guide will decide whether they are willing to do each. Then, they will reach out individually to discuss</Typography>
                  </>
                )}
              </div>
            </>
