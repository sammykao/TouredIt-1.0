  ...
  useEffect(() => {
    if (code && sessionName && sessionContainer) {
      const config = {
        ...
        options: {
          init: {
            // Disable advanced features if SharedArrayBuffer is not available
            enforceMultipleVideos: isSharedArrayBufferAvailable,
            enforceVirtualBackground: isSharedArrayBufferAvailable,
          },
          audio: {
            backgroundNoiseSuppression: isSharedArrayBufferAvailable,
          },
          video: {
            resolution: isSharedArrayBufferAvailable ? '720p' : '480p',
          },
          share: { optimizedForSharedVideo: true },
        },
        virtualBackground: {
          allowVirtualBackground: isSharedArrayBufferAvailable,
          allowVirtualBackgroundUpload: isSharedArrayBufferAvailable,
        },
      };
