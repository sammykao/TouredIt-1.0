...
const Sidebar = ({ show, onClose, bookingData, setBookingData, handleBookingSubmit }) => {
  return (
    ...
    >
      <div
        className={`fixed inset-y-0 right-0 w-80 md:w-96 h-full bg-white shadow-lg transform ${
          show ? 'translate-x-0' : 'translate-x-full'
        } transition-transform duration-300 ease-in-out z-[10000]`} // Ensure z-[10000] is applied
      >
