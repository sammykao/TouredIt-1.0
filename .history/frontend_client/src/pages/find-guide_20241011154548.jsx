          ...
          <div className="flex justify-center mt-4 mb-12">
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={toggleForm}
              />
              <div className="w-80 h-12 bg-gray-200 rounded-lg flex items-center transition-all duration-300 peer-checked:bg-blue-600">
                <div
                  className={`w-full h-full flex justify-center font-semibold items-center transition-all duration-400 ${
                    showForm ? 'bg-indigo-600 text-white' : 'bg-gray-300 text-gray-900'
                  } rounded-l-lg`}
                >
                  Custom Form
                </div>
                <div
                  className={`w-full h-full flex justify-center font-semibold items-center transition-all duration-400 ${
                    showForm ? 'bg-gray-300 text-gray-900' : 'bg-indigo-600 text-white'
                  } rounded-r-lg`}
                >
                  Popular Students
                </div>
