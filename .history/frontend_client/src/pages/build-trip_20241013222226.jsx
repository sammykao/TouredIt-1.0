...
// URL for custom pin icon (you can replace this with any other icon URL)
const customPinIcon = new L.Icon({
  iconUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.7.1/images/marker-icon.png', // Replace with your own pin image if needed
  iconSize: [25, 41],
  iconAnchor: [12, 41],
  popupAnchor: [1, -34],
...
const thumbtackIcon = new L.Icon({
  iconUrl: 'https://upload.wikimedia.org/wikipedia/commons/1/1e/Thumbtack_Icon.png', // Replace with your thumbtack image URL
  iconSize: [30, 40], // Size of the icon
  iconAnchor: [15, 40], // Point where the icon should be anchored (bottom of the pin)
  popupAnchor: [0, -35], // Where the popup should open relative to the icon
  shadowUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.7.1/images/marker-shadow.png',
  shadowSize: [41, 41],
});
          ...
          <div className="mx-auto" style={{ height: "600px", width: "80%", border: "4px solid #0a49a8", boxShadow: "0px 4px 10px rgba(0,0,0,0.3)", borderRadius: "12px", overflow: "hidden" }}>
            <MapContainer center={[42.35, -71.105]} zoom={6} style={{ height: "100%", width: "100%" }} attributionControl={false}>
              ...
              <Marker
                  ...
                  icon={customPinIcon} // Set the custom pin icon
