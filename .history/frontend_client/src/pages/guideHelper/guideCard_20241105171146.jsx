...
const GuideCard = ({ guide, handleDetails }) => (
  <>
    <style jsx>{`
      ...
      animation: gradient-border 5s linear infinite alternate; /* Animation for moving gradient */
      }
    ...
    `}</style>
    <div className='shadow-lg gradient-border flex'>
      <div
        key={guide.id}
        className="rounded-lg bg-white flex-col duration-300 hover:scale-105"
      >
        ...
        <div className="flex flex-col items-center w-full justify-center p-4 overflow-hidden">
