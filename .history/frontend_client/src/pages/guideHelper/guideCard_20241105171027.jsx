...
const GuideCard = ({ guide, handleDetails }) => (
  <>
    <style jsx>{`
      ...
      .text-center, .bio-text {
        max-width: 280px; /* Restrict width of text containers */
    ...
    <div className='shadow-lg gradient-border'>
      <div
        key={guide.id}
        className="inner-card flex flex-col items-center duration-300 hover:scale-105"
      >
        ...
        <div className="flex flex-col items-center justify-center p-4 bio-text">
