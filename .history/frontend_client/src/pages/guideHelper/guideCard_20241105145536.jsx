...
const GuideCard = ({ guide, handleDetails }) => (
  <>
    ...
    `}</style>
    <div className="shadow-lg gradient-border w-full max-w-md flex"> {/* Updated width settings */}
      <div
        key={guide.id}
        className="rounded-lg bg-white flex-col duration-300 hover:scale-105 w-full"
      >
