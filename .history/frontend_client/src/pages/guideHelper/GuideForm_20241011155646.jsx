...
const GuideForm = ({
  ...
  return (
    <div className="px-4 py-4 rounded-lg max-w-full sm:max-w-4xl sm:mx-auto sm:px-6 sm:py-6 lg:px-8 lg:py-8">
      {showForm && (
        <div className="mt-4 p-4 bg-white border border-gray-300 rounded-lg sm:p-6">
          <form onSubmit={handleFormSubmit}>
            {/* Existing form fields */}
            <div className="mb-4">
              <Typography className="mb-2 font-bold text-gray-900">$150 - 90 minutes</Typography>
              <Typography variant="medium" className="mb-2 text-left font-medium !text-gray-900 text-sm sm:text-base">
                *Please sign up or sign in before sending any tour booking requests*
              </Typography>
