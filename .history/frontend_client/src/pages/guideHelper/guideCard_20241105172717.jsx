  ...
  <>
    <style jsx>{`
      ...
      .inner-card {
        ...
        border-radius: 8px;
        width: 100%;
        max-width: 100%; /* Matches the gradient width */
        word-wrap: break-word; /* Ensures text wraps within the card */
      }

      .bio-content {
        max-width: 100%; /* Keeps bio text within the card width */
        word-wrap: break-word; /* Wraps text without overflow */
      }
    `}</style>
    <div className="shadow-lg gradient-border flex justify-center">
      <div className="inner-card flex flex-col items-center duration-300 hover:scale-105">
        ...
        <div className="text-center py-4 bio-content">
