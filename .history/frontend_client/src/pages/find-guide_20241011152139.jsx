    ...
    <div className="relative isolate px-6 pt-14 lg:px-8 min-h-screen pb-24 bg-gray-500">
      ...
      {guides.length > 0 ? (
        <>
          ...
          <Typography variant="h5" color="blue-gray" className="mt-4 rounded-xl p-4 bg-white text-center">
        ...
        <div className="bg-white px-6 py-6 m shadow rounded-lg border max-w-4xl mx-auto">
          <div className="w-full mb-6 text-center">
            <p>
              We will connect you with a personalized match. If you would like to tour or have a video chat with
