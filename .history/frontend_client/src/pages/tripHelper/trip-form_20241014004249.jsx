        ...
        <div className="mt-4 p-4 bg-white border border-gray-300 rounded-lg sm:p-6">
          <form onSubmit={handleFormSubmit}>
            ...
            <div className="mb-4">
                ...
                <select
                    name="school"
                    value={formData.school} // Value from formData
                    onChange={handleChange}  // Handle form change event
                    className="mt-1 block w-full py-2 border-gray-300 rounded-md shadow-sm text-sm sm:text-base"
                    required
                >
                <option value="">Select a school</option>
                {schoolDropdown.map((school, index) => (
            ...
            <div className="mb-4">
              <Typography variant="medium" className="mb-2 text-left font-medium !text-gray-900 text-sm sm:text-base">
                If you would like to add packages to your request, select the package(s), and we will 
                follow up with which specific tours you would like to add packages to:
              </Typography>
