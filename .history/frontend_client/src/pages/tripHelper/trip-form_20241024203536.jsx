                  ...
                  <>
                    <div className='border-2 p-2 rounded-lg'>
                      ...
                      <Input
                        ...
                        disabled  
                        className="mt-1 mb-4 block w-full py-2 border-gray-300 rounded-md shadow-sm text-sm sm:text-base"
                        required
                      />
                ...
                <>
                  <div className='border-2 p-2 rounded-lg'>
                    ...
                    <Input
                      ...
                      className="mt-1 mb-2 block w-full py-2 border-gray-300 rounded-md shadow-sm text-sm sm:text-base"
                      required
                    ...
                    <div className="flex space-x-4">  {/* Flexbox container to align inputs side by side */}
                      <div className="w-1/2">  {/* First input (From) takes half of the available width */}
                        ...
                        <Input
                          ...
                          value={field.start_date}
                          onChange={(e) => handleSchoolDateChange(index, e)}
                          className="mt-1 mb-8 block w-full border-gray-300 rounded-md shadow-sm text-sm sm:text-base"
                          required
                        />
                      </div>
