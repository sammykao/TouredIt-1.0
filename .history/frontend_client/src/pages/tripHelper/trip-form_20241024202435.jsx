            ...
            <div key={index} className="mb-4">
              ...
              { index > 0 && (
                <>
                  ...
                  <Typography variant="small" className="w-1/2 mt-4 mb-2 text-left font-medium !text-gray-900 text-sm sm:text-base">
                    From:
                  </Typography>
                  <Typography variant="small" className="w-10 mt-4 mb-2 text-left font-medium !text-gray-900 text-sm sm:text-base">
                    To:
                  </Typography>
                  <Input
                    type="date"
