...
const TripMap = ({ schools }) => {
  ...
  return (
      ...
      >
        <MapContainer
          center={locations.length > 0 ? [locations[0].lat, locations[0].lon] : [20, 0]} // Center to first location or a reasonable default
          zoom={locations.length > 0 ? 7 : 2} // Adjust zoom
