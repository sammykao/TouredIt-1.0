...
const TripForm = ({
  ...
  const handleFormSubmit = async (e) => {
        ...
        const schools = schoolDateFields.map(field => [${field.school}, ${field.date}`).join(', ');
        ...
        console.log("Submitting updatedFormData:", updatedFormData);

        try {
            // Pass the updatedFormData directly to handleSubmit
            await handleSubmit(e, updatedFormData); // Modify handleSubmit to accept updatedFormData
        } finally {
