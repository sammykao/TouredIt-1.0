...
const TripForm = ({
  ...
  const [schoolDateFields, setSchoolDateFields] = useState([{ school: school, start_date: '', end_date: ''}]);

  // Function to handle adding a new set of school-date fields
  const handleAddSchool = () => {
    setSchoolDateFields([...schoolDateFields, { school: '', start_date: '', end_date: ''}]);
  };
  ...
  const handleFormSubmit = async (e) => {
        ...
        const schoolString = schoolDateFields.map(field => `${field.school} - ${field.start_date} to ${field.end_date}`).join(', ');
        const dateString = schoolDateFields.map(field => `${field.school} - ${field.start_date} to ${field.end_date}`).join(', ');
        const schools = schoolDateFields.map(field => [field.school, field.start_date, field.end_date]);
                  ...
                  <>
                    <div className='border-2 p-2 rounded-lg'>
                      ...
                      <Input
                        ...
                        disabled  
                        className="mt-1 mb-12 block w-full py-2 border-gray-300 rounded-md shadow-sm text-sm sm:text-base"
                        required
                      />
                      <Typography variant="small" className="mt-4 underline mb-2 text-left font-medium !text-gray-900 text-sm sm:text-base">
                        Date Range
                      </Typography>
                      <div className="flex space-x-4">  {/* Flexbox container to align inputs side by side */}
                        <div className="w-1/2">  {/* First input (From) takes half of the available width */}
                          <Typography variant="small" className="mb-2 text-left font-medium !text-gray-900 text-sm sm:text-base">
                            From:
                          </Typography>
                          <Input
                        ...
                        <div className="w-1/2">  {/* Second input (To) takes half of the available width */}
                          <Typography variant="small" className="mb-2 text-left font-medium !text-gray-900 text-sm sm:text-base">
                            To:
                          </Typography>
                          <Input
                ...
                <>
                  <div className='border-2 p-2 rounded-lg'>
                    ...
                    <Input
                      ...
                      className="mt-1 mb-8 block w-full py-2 border-gray-300 rounded-md shadow-sm text-sm sm:text-base"
                      required
                    ...
                    <div className="flex space-x-4">  {/* Flexbox container to align inputs side by side */}
                      <div className="w-1/2">  {/* First input (From) takes half of the available width */}
                        ...
                        <Input
                          ...
                          value={field.start_date}
                          onChange={(e) => handleSchoolDateChange(index, e)}
                          className="mt-1 mb-4 block w-full border-gray-300 rounded-md shadow-sm text-sm sm:text-base"
                          required
                        />
                      </div>
