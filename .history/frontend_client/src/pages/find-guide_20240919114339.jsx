      ...
      {guides.length > 0 ? (
        ...
        <div className="bg-white px-6 py-6 m shadow rounded-lg border max-w-4xl mx-auto">
          <div className="w-full mb-6 text-center">
            <p>
              We will match you with a personalized guide. If you would like to tour or have a video chat with
              a student from {school}, please fill out this form, and we will find a guide there for you based on your input.
            </p>
            <div className="flex justify-center mt-12">
              <label className="relative inline-flex items-center cursor-pointer">
                <input
