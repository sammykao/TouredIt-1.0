...
const FindGuide = () => {
  ...
  const handleAdditionalInfoChange = (e) => {
    ...
    setFormData((prevData) => ({
      ...prevData,
      source: `${prevData.source}: ${additionalInfo}`,  // Append additional info directly to the source
    }));
  };
            ...
            {showForm && (
              <div className="mt-4 p-6 bg-white border border-gray-300 rounded-lg">
                <form onSubmit={handleSubmit}>
                  ...
                  {(formData.sourceV.startsWith("College Counseling") || formData.source.startsWith("Ad") && (
                    <div className="mb-4">
                      <Typography variant="small" className="mb-2 text-left font-medium !text-gray-900">
                        Please specify:
                      </Typography>
          ...
          <div className="w-full mb-6 text-center">
            ...
            <div className="mt-4 p-6 bg-white border border-gray-300 rounded-lg">
              <form onSubmit={handleSubmit}>
                ...
                {(formData.source.startsWith("College Counseling") || formData.source.startsWith("Ad")) && (
                  <div className="mb-4">
                    <Typography variant="small" className="mb-2 text-left font-medium !text-gray-900">
                      Please specify:
                    </Typography>
