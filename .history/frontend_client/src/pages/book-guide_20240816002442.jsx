            ...
            <>
              ...
              <div className="mb-4 space-y-4">
                {guideInfo?.greek_life && (
                  <div
                    className={`border p-4 rounded-lg cursor-pointer ${
                      bookingData.greek_life ? 'bg-yellow-500 border-yellow-600' : 'bg-white border-gray-800'
                    }`}
                ...
                {guideInfo?.student_athlete && (
                  <div
                    className={`border p-4 rounded-lg cursor-pointer ${
                      bookingData.student_athlete ? 'bg-yellow-500 border-yellow-600' : 'bg-white border-gray-800'
                    }`}
                ...
                {guideInfo?.paid_internship && (
                  <div
                    className={`border p-4 rounded-lg cursor-pointer ${
                      bookingData.paid_internship ? 'bg-yellow-500 border-yellow-600' : 'bg-white border-gray-800'
                    }`}
