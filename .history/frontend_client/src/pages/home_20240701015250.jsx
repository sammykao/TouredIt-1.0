...
function TestimonialCard({
  ...
  return (
    <Card shadow={false} className="bg-gray-100/50 rounded-2xl p-6">
      ...
      <CardBody className="px-4 py-2 flex flex-wrap-reverse gap-x-6 justify-between items-center">
        <div>
        ...
        <img src={img} className="max-w-[8rem] max-h-[6rem] rounded-lg" alt={client} />
      </CardBody>
    </Card>
  );
}
const testimonials = [
  {
    ...
    clientInfo: "Student touring Duke",
    img: "https://touredit-logos.s3.us-east-2.amazonaws.com/Duke+University_logo.jpg",
  },
  {
    title:
    ...
    clientInfo: "Parent of student touring UPenn",
    img: "https://touredit-logos.s3.us-east-2.amazonaws.com/University+of+Pennsylvania_logo.jpg",
  },
];
            ...
            >
              ...
              <CardBody className="items-center mx-auto py-4">
                <img
                  ...
                  className="rounded-lg max-w-[8rem] mx-auto my-2"
                  alt="spotify"
                />
                <Typography variant="h6" color="blue-gray">
                  Robert Taylor
