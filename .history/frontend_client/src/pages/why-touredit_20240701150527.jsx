...
import { BriefcaseIcon, LockClosedIcon, ServerIcon } from '@heroicons/react/24/solid'
                ...
                <div className="max-w-xl text-base leading-7 text-gray-850 lg:max-w-lg">
                  ...
                  <ul role="list" className="mt-8 space-y-8 text-gray-600">
                    <li className="flex gap-x-3">
                      ...
                      <span>
                        <strong className="font-semibold text-gray-900">Potential future internship referrals.</strong> 
                        Use that connection to ask for referrals in the future! No promises though.
                      </span>
                    </li>
                    <li className="flex gap-x-3">
