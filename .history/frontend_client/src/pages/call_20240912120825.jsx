...
export function VideoCall() {
    ...
    const code = query.get('code');     // Extract code from query string
    ...
    return (
        ...
        <div className="relative isolate px-6 pb-20 pt-14 lg:px-8 min-h-screen bg-gray-500">
            ...
            <div className='flex justify-center align-center mx-auto mt-32'>

                {/* The UI Toolkit will render the video session here, including its prebuilt leave button */}
                <div id="sessionContainer" style={{ height: '1000px', width: '80%' }}></div>
            </div>
