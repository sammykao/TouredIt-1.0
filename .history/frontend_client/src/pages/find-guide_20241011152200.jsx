      ...
      {guides.length > 0 ? (
        ...
        <div className="bg-white px-6 py-6 m shadow rounded-lg border max-w-4xl mx-auto">
          <div className="w-full mb-6 text-center">
            <p>
              We will pair you with a personalized match. If you would like to connect with a s{school}, please fill out this form, and we will find a student there for you based 
              on your input.
            </p>
            <div className="flex justify-center mt-12">
              <label className="relative inline-flex items-center cursor-pointer">
