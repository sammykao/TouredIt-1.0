                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-sm ${bookingData.paid_internship ? 'text-gray-200' : 'text-gray-500'}`}>Your guide has noted paid internship experience. Learn about the internship recruitment process, how to get internships as a college student.</p>
