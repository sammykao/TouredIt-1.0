            ...
            <>
              ...
              <div className="mb-4 space-y-4">
                ...
                {guideInfo?.paid_internship && (
                  ...
                  <Typography className='text-sm text-gray-700'>For each of the package add-ons, your guide will decide whether they are willing to do the add-on. 
                    They will reach out individually to discuss their decision. Then, our team will confirm with both parties about logistics and prices. </Typography>
                  </>
                )}
              </div>
            </>
