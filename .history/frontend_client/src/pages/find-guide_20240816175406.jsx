...
const FindGuide = () => {
  ...
  useEffect(() => {
    const fetchGuides = async () => {
      ...
      try {
        const response = await axios.post('http://localhost:3000/api/allGuides', { school });
  ...
  const handleSourceChange = (value) => {
    setFormData((prevData) => ({
      ...prevData,
      source: value,  // Set the source value directly
    }));
  };
  ...
  const handleAdditionalInfoChange = (e) => {
    ...
    setFormData((prevData) => ({
      ...prevData,
      additionalInfo: additionalInfo,  // Append additional info directly to the source
    }));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('http://localhost:3000/api/sendCustomRequest', { data: formData, email: sessionStorage.username });
      setFormData({
        school: school,
        major: '',
        grade: '',
                        ...
                        >
                            ...
                            <div className="ml-4">
                                ...
                                <p className={`text-sm my-2 ${formData.greek_life ? 'text-gray-200' : 'text-gray-900'}`}>
                                    Spend an extra 30 minutes to learn about the Greek life on campus, the rush process, 
                        ...
                        >
                            ...
                            <div className="ml-4">
                                ...
                                <p className={`text-sm my-2 ${formData.student_athlete ? 'text-gray-200' : 'text-gray-900'}`}>
                                    Spend an extra 30 minutes to learn about the recruiting process, balancing academics 
                        ...
                        >
                            ...
                            <div className="ml-4">
                                ...
                                <p className={`text-sm my-2 ${formData.paid_internship ? 'text-gray-200' : 'text-gray-900'}`}>
                                    Spend an extra 30 minutes to learn about the internship recruitment process, how to get 
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  ...
                  <select
                      ...
                      value={formData.source}
                      onChange={(e) => handleSourceChange(e.target.value)}
                      className="mt-1 block w-full py-2 border-gray-900 rounded-md shadow-sm"
                      closeOnSelect
                  >
                      <option value="">Select an option</option>
                      <option value="Social Media">Social Media</option>
