...
import { Textarea, Input, Typography, Button, Select, Option, Checkbox } from "@material-tailwind/react";
...
const FindGuide = () => {
  ...
  const handleSourceChange = (value) => {
    setFormData((prevData) => ({
      ...prevData,
      source: value,
      additional_info: '',  // Reset additional_info when source changes
    }));
  };
  ...
  const handleAdditionalInfoChange = (e) => {
    setFormData((prevData) => ({
      ...
      source: `${prevData.source}: ${e.target.value}`,  // Update source with additional info
    }));
  };
