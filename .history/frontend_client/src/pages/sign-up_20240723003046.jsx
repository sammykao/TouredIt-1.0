...
export function SignUp() {
  ...
  const insertBackend = async () => {
    ...
    try {
      const response = await axios.post('https://naz5teqmllduknrtpdeor6ig5e0lfdhw.lambda-url.us-east-2.on.aws/api/newClient', newAccount);
      return;
    } catch (error) {
      console.error('Error Inserting Account:', error);
    }
    try {
      const response = await axios.post('https://naz5teqmllduknrtpdeor6ig5e0lfdhw.lambda-url.us-east-2.on.aws/api/updateClient', newAccount);
      return;
    } catch (error) {
