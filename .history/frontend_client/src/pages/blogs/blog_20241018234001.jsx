...
export function Blog() {
  ...
  const client = createClient({
    space: import.meta.env.CONTENTFUL_SPACE_ID, // Replace with your space ID
    accessToken: import.meta.env.CONTENTFUL_API_KEY, // Replace with your Content Delivery API access token
  });
