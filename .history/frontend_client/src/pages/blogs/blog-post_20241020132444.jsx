...
export function BlogPost() {
  ...
  const renderOptions = {
    renderNode: {
      ...
      [BLOCKS.PARAGRAPH]: (node, children) => <p className="text-base sm:text-lg leading-relaxed mb-6">{children}</p>,
      [BLOCKS.UL_LIST]: (node, children) => <ul className="list-disc list-inside ml-4 sm:ml-6 mb-4">{children}</ul>,
