...
import { useLocation } from 'react-router-dom'; // To access the query string
...
export function BlogPost() {
  ...
  const postId = query.get('post'); // Extract the 'post' query string value
  ...
  useEffect(() => {
    const fetchPost = async () => {
      ...
      try {
        const response = await client.getEntry(postId); // Fetch the post using the ID
