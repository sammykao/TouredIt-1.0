    ...
    const fetchPosts = async () => {
        try {
          const response = await client.getEntries({
            content_type: import.meta.env.VITE_CONTENTFUL_CONTENT, // Replace 'YOUR_CONTENT_TYPE_ID' with the correct ID
          });
  ...
  return (
    <>
      <div className="relative isolate px-6 pb-20 pt-14 lg:px-8 min-h-screen bg-gray-500">
        ...
        <div className="bg-white rounded-xl container mx-auto mt-44 py-2">
