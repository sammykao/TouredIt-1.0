...
export function BlogPost() {
  ...
  if (loading) { 
    return (
        <div className="flex mt-24 mb-32 items-center justify-center px-6 pt-14">
            <div
      ...
      <div className="container mx-auto mt-16 sm:mt-32">
        {post ? (
          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg">
            <h1 className="text-2xl sm:text-4xl font-bold text-center mb-14">{post.fields.title}</h1>
