            ...
            <>
              ...
              {`
                ...
                .circular-gradient-border {
                  ...
                  background: conic-gradient(from 0deg, #000000, #333, #4d4d4d, #000000); /* Circular gradient */
                  background-size: 200% 200%;
                  animation: rotate-gradient 4s linear infinite; /* Rotate the gradient */
                }
                ...
                .circular-gradient-border::before {
                  ...
                  z-index: -1;
                  border-radius: 8px;
                  background-color: white; /* Inside content background */
