                ...
                <div className="max-w-xl text-base leading-7 text-gray-850 lg:max-w-lg">
                  ...
                  <ul role="list" className="mt-8 space-y-8 text-gray-700">
                    ...
                    <li className="flex gap-x-3">
                      ...
                      <span>
                        <strong className="font-semibold text-gray-900">Learn how to maximize your experience.</strong> Your guide can give you insights on what classes to take, the best dorms, and how to get started recruiting for an internship.
                      </span>
                    </li>
                  </ul>
                  <p className="mt-8">
