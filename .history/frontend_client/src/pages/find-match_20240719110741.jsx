...
const FindMatch = () => {
  ...
  if (error) {
    return (
      <div className="w-full flex items-center m-24 mb-32 justify-center px-6 pt-14">
        <p className="w-full text-center justify center font-bold sm:text-md lg:text-3xl">Something went wrong. Try again later.</p>
      </div>
    );
  }
