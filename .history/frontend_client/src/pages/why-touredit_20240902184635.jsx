...
export function WhyTouredIt() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://lera2ibwne.execute-api.us-east-2.amazonaws.com/api/ddEmailToNewsletter', {
        email,
  ...
  return (
    <>
      <div className="relative isolate px-6 pb-20 pt-14 lg:px-8 min-h-screen bg-gray-500">
        ...
        <div className="bg-white py-12 sm:py-24 mt-20">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                Stay Updated with TouredIt
              </h2>
              <p className="mt-4 text-lg leading-6 text-gray-600">
                Sign up for our newsletter and never miss out on the latest updates and exclusive offers.
              </p>
            </div>
