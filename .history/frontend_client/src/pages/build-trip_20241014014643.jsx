          ...
          showMap && (
            <div className="bg-white mt-40 px-6 py-6 rounded-lg mx-auto">
              <div className="w-full mb-6 text-center">
                  <h1 className="text-2xl sm:text-4xl leading-7 text-black">Thanks for submitting an itinerary request </h1>
                  <h1 className="text-xl sm:text-2xl leading-7 text-black">Checkout your spots on the map, and we will get back to you.</h1>
