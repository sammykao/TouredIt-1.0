          ...
          {showForm ? (
            <>
              ...
              <div className="flex justify-center text-center">
                <div
                    className={`w-11 h-12 flex justify-center text-sm sm:text-md font-semibold items-center transition-all duration-400 ${
                  ...
                  <div
                    className={`w-11 h-6 flex justify-center text-sm sm:text-md font-semibold items-center transition-all duration-400 ${
