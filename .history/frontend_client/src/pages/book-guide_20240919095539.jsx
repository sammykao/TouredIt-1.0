        ...
        <div className="flex-1 overflow-hidden">
          ...
          <div className="mt-6 text-center md:text-left">
            <button
              ...
              className="bg-blue-600 mr-2 mb-4 text-white px-4 py-1 rounded-lg hover:bg-blue-900"
            >
              Request a Tour
            </button>
            <button
              onClick={() => setShowCallSidebar(true)}
              className="bg-blue-600 text-white ml-2 px-4 py-1 rounded-lg hover:bg-blue-900"
            >
