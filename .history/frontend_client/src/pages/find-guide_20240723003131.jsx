...
const FindGuide = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://naz5teqmllduknrtpdeor6ig5e0lfdhw.lambda-url.us-east-2.on.aws/api/sendCustomRequest', { data: formData, email: sessionStorage.username });
    ...
    <div className="relative isolate px-6 pt-14 lg:px-8 min-h-screen pb-24 bg-gray-500">
      ...
      {guides.length > 0 ? (
        <>
            ...
            {filteredGuides.map((guide) => (
              ...
              >
                <div className="flex p-4 items-center justify-center">
                  <img 
                    src={`https://naz5teqmllduknrtpdeor6ig5e0lfdhw.lambda-url.us-east-2.on.aws/images/${guide.profile_image_url}`} 
                    alt={guide.name} 
          ...
          <div className="px-6 py-6 mt-24 rounded-lg max-w-4xl mx-auto">
          <Typography
              variant="h5"
              color="blue-gray"
