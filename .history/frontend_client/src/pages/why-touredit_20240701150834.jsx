                ...
                <div className="max-w-xl text-base leading-7 text-gray-850 lg:max-w-lg">
                  ...
                  <ul role="list" className="mt-8 space-y-8 text-gray-700">
                    ...
                    <li className="flex gap-x-3">
                      ...
                      <span>
                        <strong className="font-semibold text-gray-900">Navigate the social scene.</strong> Your guide can be another friend on campus. They can give you inisghts and help you navigate t
                      </span>
                    </li>
                    <li className="flex gap-x-3">
