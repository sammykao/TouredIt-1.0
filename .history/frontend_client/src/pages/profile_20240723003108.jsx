...
export function Profile() {
  ...
  useEffect(() => {
    axios.post("https://naz5teqmllduknrtpdeor6ig5e0lfdhw.lambda-url.us-east-2.on.aws/api/accountInfo", { email })
      .then(response => {
    ...
    axios.post("https://naz5teqmllduknrtpdeor6ig5e0lfdhw.lambda-url.us-east-2.on.aws/api/clientTours", { email })
      .then(response => {
  ...
  const handleEditSave = () => {
    axios.post("https://naz5teqmllduknrtpdeor6ig5e0lfdhw.lambda-url.us-east-2.on.aws/api/updateClient", formData)
      .then(response => {
        setAccountInfo(response.data.account);
        setIsEditing(false);
      })
