          ...
          <div className="flex justify-center mt-4 mb-20">
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={toggleForm}
              />
              <div className="w-60 h-16 bg-gray-200 rounded-lg flex items-center transition-all duration-300 peer-checked:bg-blue-600">
                <div
                  className={`w-1/2 h-full px-2 flex justify-center items-center transition-all duration-300 ${
                ...
                <div
                  className={`w-1/2 h-full px-2 flex justify-center text-semi-bold items-center transition-all duration-300 ${
                    showForm ? 'bg-gray-300 text-gray-900' : 'bg-blue-600 text-white'
                  } rounded-r-lg`}
                >
                  Recent Popular Students
                </div>
              </div>
            </label>
          </div>
