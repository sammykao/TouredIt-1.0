...
export function ContactUs() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setSuccessMessage('Thank you for reaching out! Your message has been successfully submitted. We appreciate your interest and will get back to you within 24 hours. In the meantime, feel free to explore our services. Have a great day!
<a href="/home" class="text-blue-500">Return to homepage</a>.');
        } catch (error) {
