...
const FindGuide = () => {
  ...
  useEffect(() => {
    ...
    if (location.state && location.state.newformData && location.state.newSchools) {
      ...
      // Use history.replace to update the state after submission
      history.replace({ ...location, state: { ...location.state, newformData: null, newSchools: null } });
      ...
      history.replace({ ...location, state: { ...location.state, formData: null } });
    }
