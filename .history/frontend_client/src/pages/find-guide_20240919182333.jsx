      ...
      {guides.length > 0 ? (
              ...
              <div className="flex justify-center mt-12">
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <span className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">
                    {isGuideForm ? 'Guide Form' : 'Call Guide Form'}
                  </span>
                </label>
              </div>
              {isGuideForm ? (
        ...
        <div className="bg-white px-6 py-6 m shadow rounded-lg border max-w-4xl mx-auto">
          <div className="w-full mb-6 text-center">
            <p>
              We will match you with a personalized match. If you would like to tour or have a video chat with
              a student from {school}, please fill out this form, and we will find a student there for you based 
              on your input.
            </p>
            <div className="flex justify-center mt-12">
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={toggleFormType}
                />
                <div className="w-13 h-8 bg-gray-200 rounded-full peer peer-focus:ring-6 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600" />
                <span className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">
                  {isGuideForm ? 'Tour Request' : 'Call Request'}
                </span>
              </label>
            </div>
