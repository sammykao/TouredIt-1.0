  ...
  return (
    <div className="relative isolate px-6 pt-14 lg:px-8 min-h-screen pb-24 bg-gray-500">
      ...
      <div className="bg-white px-6 py-6 mt-24 shadow rounded-lg border max-w-4xl mx-auto">
        <h2 className="text-3xl font-bold mb-4 text-center">Guides for {school}</h2>
        {guides.length > 0 ? (
          <>
            ...
            <div className="bg-white px-6 py-6 mt-24 shadow rounded-lg border max-w-4xl mx-auto"></div>
