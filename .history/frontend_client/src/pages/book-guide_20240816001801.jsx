                ...
                {guideInfo?.greek_life && (
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <h2 className={`font-bold ${bookingData.greek_life ? 'text-white' : 'text-gray-700'}`}>Greek Life Experience</h2>
                ...
                {guideInfo?.student_athlete && (
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <h2 className={`font-bold ${bookingData.student_athlete ? 'text-white' : 'text-gray-700'}`}>Student Athlete Add-On</h2>
                ...
                {guideInfo?.paid_internship && (
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <h2 className={`font-bold ${bookingData.paid_internship ? 'text-white' : 'text-gray-800'}`}>Internship Insights</h2>
