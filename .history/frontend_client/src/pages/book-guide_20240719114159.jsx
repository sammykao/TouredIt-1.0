...
const BookGuide = () => {
  ...
  return (
    <div className="relative isolate min-h-screen bg-gray-500 px-6 pt-40 pb-24">
      ...
      <div className="bg-white mt-24 shadow rounded-lg max-w-5xl mx-auto p-6 flex space-x-6">
          ...
          <div className="text-gray-700">
            ...
            {(guideInfo?.major || guideInfo?.secondary_major || guideInfo?.minor || guideInfo?.secondary_minor) && (
              <div className="mt-2">
                ...
                {guideInfo.secondary_major && <p><strong> Major:</strong> {guideInfo.secondary_major}</p>}
