        ...
        <>
          ...
          {showForm && (
            <>
              ...
              {/* Add wrapper div for form transitions using Tailwind for both forms */}
              <div className="relative">
                <div
                  className={`absolute inset-0 transition-opacity duration-500 transform ${
                    isGuideForm ? 'opacity-100 translate-y-0 z-10' : 'opacity-0 -translate-y-5 pointer-events-none'
                  }`}
                  key="guide-form"
                >
                  {isGuideForm && (
