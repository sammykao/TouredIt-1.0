          ...
          <div className="flex justify-center mt-4 mb-12">
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={toggleForm}
              />
              <div className="w-60 h-10 bg-gray-200 rounded-lg flex items-center transition-all duration-300 peer-checked:bg-blue-600">
                <div
                  className={`w-full h-full flex justify-center font-semibold items-center text-md transition-all duration-400 ${
                ...
                <div
                  className={`w-full h-full flex justify-center font-semibold items-center text-sm transition-all duration-400 ${
