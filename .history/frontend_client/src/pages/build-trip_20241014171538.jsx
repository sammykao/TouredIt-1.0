...
export function BuildTrip() {
  ...
  const handleSubmit = (e, newformData, newSchools) => {
    e.preventDefault();
    ...
    try {
      axios.post('https://lera2ibwne.execute-api.us-east-2.amazonaws.com/api/sendCustomRequest', { data: newformData, email: sessionStorage.username });
    } catch (error) {
