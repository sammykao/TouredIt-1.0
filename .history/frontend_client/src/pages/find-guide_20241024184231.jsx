      ...
      {guides.length > 0 ? (
        <>
          ...
          {showForm ? (
            ...
            <div className='transition-transform transform duration-500 ease-in-out translate-y-5 opacity-0'>
              <GuideFilters
                selectedCategory={selectedCategory} 
                handleCategoryChange={handleCategoryChange} 
                className="transition-transform transform duration-500 ease-in-out translate-y-5 opacity-0"
              />
