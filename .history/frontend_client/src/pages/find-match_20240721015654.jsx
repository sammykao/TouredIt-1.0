...
const FindMatch = () => {
  ...
  return (
      <div className="px-4 py-4 overflow-hidden shadow bg-white m-24 mb-32 rounded-lg flex flex-col items-center max-w-4xl mx-auto">
        ...
        <div className="w-full mb-4">
          <input
            ...
            className="w-full text-xl p-2 text-white shadow rounded focus:outline-none focus:bg-gray-400"
