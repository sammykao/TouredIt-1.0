    ...
    <>
      ...
      <Parallax
          ...
          renderLayer={(percentage) => (
            <div
              style={{
                transform: `scale(${1 + percentage}) translateY(${
                  percentage * 50
                }px)`,
              }}
            ...
            >
              <div
                className="h-96 w-96 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 blur-2xl opacity-50"
                style={{
                  transform: `scale(${1 + percentage * 0.5})`,
                }}
              ></div>
              <div
                className="h-64 w-64 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 blur-lg opacity-70"
                style={{
                  transform: `scale(${1 + percentage * 0.7}) translateY(-30px)`,
                }}
              ></div>
            </div>
          )}
        >
          <div className="h-[300px] flex flex-col justify-center items-center">
            ...
            >
              Personalize your campus visits with ease.
            </Typography>
          </div>
        </Parallax>
