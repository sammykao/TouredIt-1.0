...
const FindMatch = () => {
  ...
  if (error) {
    return (
      <div className="flex items-center lg:m-24 lg:mb-32 sm:m-12 sm:mb-24 justify-center px-6 pt-14">
        <p className="text-center justify center font-bold sm:text-md lg:text-3xl">Something went wrong. Try again later.</p>
      </div>
    );
  }
