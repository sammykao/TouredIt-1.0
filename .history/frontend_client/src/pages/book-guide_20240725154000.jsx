...
const BookGuide = () => {
  ...
  return (
    <div className="relative isolate min-h-screen bg-gray-500 px-6 pt-40 pb-24">
      ...
      <div className="bg-white mt-24 shadow rounded-lg max-w-5xl mx-auto p-6 flex flex-col md:flex-row space-y-6 md:space-y-0 md:space-x-6 overflow-hidden">
          ...
          <div className="mt-4 text-center text-gray-700 md:text-left">
            {guideInfo?.activities && guideInfo.activities.length > 0 && (
              <>
                ...
                <ul className="list-inside tex-md space-y-2 overflow-hidden overflow-ellipsis">
