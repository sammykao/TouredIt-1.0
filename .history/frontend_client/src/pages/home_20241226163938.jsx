...
import { Autoplay, Pagination } from "swiper/modules"; xport function TestimonialCard({ img, client, title, clientInfo }) {
  return (
...
}xport function TestimonialCard({ img, client, title, clientInfo }) {
  return (
    <Card shadow={false} className="bg-gray-100/50 rounded-2xl h-[20rem] sm:h-[24rem] flex flex-col justify-between p-4 sm:p-6">
      <CardHeader color="transparent" floated={false} shadow={false}>
        <Typography
