        ...
        <div class="py-24 mt-12 sm:py-32">
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:text-center">
              ...
              find the best fit to really succeed once they get on campus
              </p>
            </div>
              ...
              <dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
                <div class="relative pl-16">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
                    ...
                    Personalized On-Campus Tours
                  </dt>
                  <dd class="mt-2 text-base leading-7 text-gray-800">1-on-1 college tours with a current student. These students are matched based on you or your child's
                ...
                <div class="relative pl-16">
                  ...
                  <dd class="mt-2 text-base leading-7 text-gray-900">While touring your future campus connect on a peer to peer level with your guide and future classmate.
                    They can help you or your child succeed once they get on campus - Whether that's prestigious referrals or social navigation tips, this is the first
                    step to you or your child's networking journey
                  </dd>
                </div>
                <div class="relative pl-16">
                  <dt class="text-base font-semibold leading-7 text-gray-900">
