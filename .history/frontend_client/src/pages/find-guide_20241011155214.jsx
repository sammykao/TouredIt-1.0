          ...
          <div className="flex justify-center mt-4 mb-12">
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={toggleForm}
              />
              <div className="w-60 h-10 sm:w-80 sm:h-12 bg-gray-200 rounded-lg flex items-center transition-all duration-300">
                <div
                ...
                <div
                  className={`w-full h-full flex justify-center text-sm sm:text-1/2-lg font-semibold items-center transition-all duration-400 ${
