...
const Sidebar = ({ show, onClose, bookingData, setBookingData, handleBookingSubmit }) => {
  return (
    <div
      className={`fixed absolute inset-0 w-full h-full bg-black bg-opacity-50 z-50 transition-opacity duration-300 ease-in-out ${
    ...
    >
      <div
        ...
        } transition-transform duration-300 ease-in-out z-50`} // Ensure z-50 is applied
      >
