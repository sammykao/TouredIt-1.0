  ...
  if (loading) {
    return (
      <div className="relative isolate justify-center px-6 pt-14 lg:px-8 min-h-screen pb-24 bg-gray-500">
        ...
        <div
          style=""
          className="inline-block justify-centerh-8 w-8 animate-spin rounded-full border-4 border-solid border-current border-r-transparent align-[-0.125em] motion-reduce:animate-[spin_1.5s_linear_infinite]"
          role="status">
          <span
