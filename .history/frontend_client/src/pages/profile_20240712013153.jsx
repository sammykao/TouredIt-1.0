...
export function Profile() {
  ...
  return (
    <div className="relative isolate px-6 pt-16 pb-16 lg:px-8 min-h-screen pb-24 bg-gray-500">
      <div
      ...
      {accountInfo ? (
            <div class="bg-white overflow-hidden mt-24 shadow rounded-lg border">
