                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-sm my-2 ${bookingData.student_athlete ? 'text-gray-200' : 'text-gray-900'}`}>Spend an extra 30 minutes to learn about the recruiting process, 
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className={`text-sm my-2 ${bookingData.paid_internship ? 'text-gray-200' : 'text-gray-900'}`}>Spend an extra 30 minutes to earn about the internship recruitment process, how to get internships as a college student, 
