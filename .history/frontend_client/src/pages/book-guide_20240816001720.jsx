                ...
                {guideInfo?.greek_life && (
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <h2 className={`font-bold ${bookingData.greek_life ? 'text-white' : 'text-gray-700'}`}>Greek Life Experience</h3>
                ...
                {guideInfo?.student_athlete && (
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <h2 className={`font-bold ${bookingData.student_athlete ? 'text-white' : 'text-gray-700'}`}>Student Athlete Add-On</h3>
