                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div className="mt-8 sm:mx-auto sm:max-w-lg sm:flex sm:flex-col sm:items-center">
                        ...
                        <input
                            ...
                            className="w-full rounded-md border border-gray-300 px-5 py- text-base text-gray-900 placeholder-gray-500 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:max-w-xs"
