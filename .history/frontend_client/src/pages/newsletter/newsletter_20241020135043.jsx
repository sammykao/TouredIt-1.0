            ...
            <div className="bg-gray-200 sm:w-2/3 mx-auto rounded-xl py-8 sm:py-16 mt-4 mb-8">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div className="mt-8 sm:mx-auto sm:max-w-lg sm:flex sm:flex-col sm:items-center">
                        ...
                        <Button
                            type="submit"
                            className={`mt-3 w-full py-2 px-6 font-semibold shadow-sm hover:bg-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:flex-shrink-0 ${loading ? 'bg-gray-400' : 'bg-blue-800 text-white'}`}
