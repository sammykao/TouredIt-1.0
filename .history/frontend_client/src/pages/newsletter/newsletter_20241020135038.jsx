                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div className="mt-8 sm:mx-auto sm:max-w-lg sm:flex sm:flex-col sm:items-center">
                        ...
                        <input
                            ...
                            className="w-full rounded-md border border-gray-300 px-5 py-1 text-base text-gray-900 placeholder-gray-500 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:max-w-xs"
                            placeholder="Enter your email"
                            disabled={loading} // Disable input while loading
                        />
                        <Button
                            type="submit"
                            className={`mt-3 w-full py-1 px-6 font-semibold shadow-sm hover:bg-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:flex-shrink-0 ${loading ? 'bg-gray-400' : 'bg-blue-800 text-white'}`}
