  ...
  return (
    <>
      <div className="relative isolate px-6 pb-20 pt-14 lg:px-8 min-h-screen bg-gray-500">
        ...
        <div className="mt-40">
          <div className="mx-auto" style={{ height: "500px", width: "80%", border: "4px solid #0a49a8", boxShadow: "0px 4px 10px rgba(0,0,0,0.3)", borderRadius: "12px", overflow: "hidden" }}>
            <MapContainer center={[42.35, -71.105]} zoom={5} style={{ height: "100%", width: "100%" }} attributionControl={false}>
