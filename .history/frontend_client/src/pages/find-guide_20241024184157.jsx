        ...
        <>
          ...
          {showForm ? (
            ...
            <div className='transition-all duration-500 ease-in-out'>
              <div className=' duration-1000 ease-in-out transform'>

              </div>
              <div className="grid mt-12 gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 pt-4 duration-1000 ease-in-out transform">
