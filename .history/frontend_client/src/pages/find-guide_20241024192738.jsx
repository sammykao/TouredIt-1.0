            ...
            <>
              <style jsx>{`
                ...
                .gradient-border {
                  ...
                  background: linear-gradient(270deg, #05f6fa, #01131c, #05f6fa);
                  background-size: 200% 200%; /* This makes the gradient large enough to animate */
                  animation: gradient-border 3s linear infinite alternate; /* Animation for moving gradient */
                }
              ...
              <div className="grid mt-12 gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 pt-4">
                {filteredGuides.map((guide) => (
                  <div key={guide.id} className="gradient-border rounded-lg">
                    <GuideCard 
                      guide={guide} 
