...
const FindMatch = () => {
  ...
  if (loading) {
    return (
      <div className="flex m-24 items-center justify-center px-6 pt-14">
        <div
  ...
  if (error) {
    return (
      <div className="flex items-center m-24 justify-center px-6 pt-14">
        <p className="text-center justify center text-3xl">Something went wrong. Try again later.</p>
      </div>
    );
  }

  return (
      <div className="bg-gray-100/50 px-4 py-4 overflow-hidden m-24 mb-32 shadow rounded-lg flex flex-col items-center max-w-4xl mx-auto">
        ...
        <button
          ...
          size="xs"
          variant="gradient"
          className="bg-blue-400 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded focus:outline-none focus:shadow-outline"
        >
          Find a match
        </button>
      </div>
