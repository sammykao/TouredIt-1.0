      ...
      <div className="relative isolate px-6 pt-14 lg:px-8 min-h-screen bg-gray-500">
        ...
        <section className="px-8 pb-8">
            ...
            >
              ...
              <CardBody className="items-center mx-auto py-2">
                <img
                  ...
                  className="max-w-[8rem] rounded-lg mx-auto"
                  alt="spotify"
                />
                <Typography variant="h6" color="blue-gray">
                  Robert Taylor
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="/find-match"
                className="rounded-md bg-blue-800 px-6.5 py-5.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
