...
function TestimonialCard({
  ...
  return (
    <Card shadow={false} className="bg-gray-100/50 rounded-2xl p-6 h-full flex flex-col">
      ...
      <CardBody className="flex flex-col text-center lg:text-left lg:flex-row lg:justify-between lg:items-center">
        ...
        <img src={img} className="rounded-lg max-w-[8rem] py-2 mx-auto lg:mx-0" alt={client} />
      </CardBody>
    </Card>
  );
}
          ...
          <div className="container mx-auto">
            ...
            >
              <CardHeader color="transparent" floated={false} shadow={false}>
                <Typography
                  color="blue-gray"
                  className="mb-4 !text-lg lg:!text-2xl max-w-4xl !leading-snug mx-auto font-bold"
                >
              ...
              <CardBody className="items-center mx-auto py-2">
                <img
                  ...
                  className="max-w-[8rem] mx-auto my-2"
                  alt="spotify"
                />
                <Typography variant="h6" color="blue-gray">
                  Robert Taylor
