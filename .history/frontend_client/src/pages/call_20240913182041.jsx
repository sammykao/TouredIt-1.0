...
export function VideoCall() {
  ...
  return (
    <div className="relative isolate px-3 pb-20 pt-14 lg:px-8 min-h-screen bg-gray-500">
      <div id="join-flow" className="mt-48 flex-col justify-center align-center">
        {/* Session Container */}
        <h1 className='w-full mx-auto justify-center text-center m-8'>TouredIt Video Call</h1>
        <div
          id="sessionContainer"
