          ...
          <div className="flex justify-center mt-4 mb-12">
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={toggleForm}
              />
              <div className="w-80 h-16 bg-gray-200 rounded-lg flex items-center transition-all duration-300 peer-checked:bg-blue-600">
                <div
                  className={`w-full h-full flex justify-center font-semibold items-center transition-all duration-300 ${
