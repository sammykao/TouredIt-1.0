        ...
        <div class="py-24 mt-12 sm:py-32">
          <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:text-center">
              ...
              <p class="mt-6 text-lg leading-8 text-gray-600">College isn't like what it used to be - It's a hypercompetitive atmosphere. Nowadays, students must really
              get a great understanding of their future school for when they're applying, and to help them succeed once they're on campus
              </p>
            </div>
