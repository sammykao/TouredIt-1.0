...
const Sidebar = ({ show, onClose, bookingData, setBookingData, handleBookingSubmit, guideInfo }) => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            await handleBookingSubmit(e); // Call the original handleBookingSubmit
        } finally {
                                ...
                                {guideInfo?.greek_life && (
                                    ...
                                    >
                                        <div className="flex items-center">
                                            <Diversity3OutlinedIcon className={`${bookingData.greek_life ? 'text-white' : 'text-[#ca8a04]'}`} />
                                            <div className="ml-4">
                        ...
                        <div className="text-center">
                            ...
                            {!isSubmitting ? (
                                ...
                                <div className="flex justify-center items-center">
                                    <div className="animate-spin rounded-full h-8 w-8 border-t-4 border-green-600 border-solid"></div>
                                    <Typography className="ml-2 text-green-600">Submitting...</Typography>
                                </div>
                            )}
                        </div>
                    </form>
