...
const FindGuide = () => {
  ...
  const logo = "https://touredit-logos.s3.us-east-2.amazonaws.com/" + logo + "_logo.jpg"
  ...
  return (
    <div className="relative isolate px-6 pt-14 lg:px-8 min-h-screen pb-24 bg-gray-500">
      ...
      <img className='mt-36 justify-center' src={logo}></img>
      <h2 className="text-3xl font-bold mb-4 text-center mt-8 justify-center">Guides for {school}</h2>
      {guides.length > 0 ? (
        <>
