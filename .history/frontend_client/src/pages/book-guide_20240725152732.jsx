              ...
              <>
                ...
                <ul className="list-inside space-y-1">
                  {guideInfo.activities.map((activity, index) => (
                    <li key={index}>
                      <div className={expandedItems.activities?.[index] ? "whitespace-normal" : "truncate overflow-hidden"}>
              ...
              <>
                ...
                <ul className="list-inside space-y-1">
                  {guideInfo.hobbies.map((hobby, index) => (
                    <li key={index}>
                      <div className={expandedItems.hobbies?.[index] ? "whitespace-normal" : "truncate overflow-hidden"}>
