      ...
      >
        ...
        {guides.length > 0 ? (
          <>
            ...
            <div className="bg-white px-6 py-6 m-4 shadow rounded-lg border max-w-4xl mx-auto">
          ...
          <div className="bg-white px-6 py-6 mt-8 shadow rounded-lg border max-w-4xl mx-auto">
