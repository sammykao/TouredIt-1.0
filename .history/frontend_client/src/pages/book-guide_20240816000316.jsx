            ...
            <>
              ...
              <div className="mb-4 flex justify-around">
                {guideInfo?.greek_life && (
                  <div
                    className={`p-2 cursor-pointer rounded-full ${
                      bookingData.greek_life ? 'bg-yellow-500' : 'bg-gray-200'
                    }`}
                ...
                {guideInfo?.student_athlete && (
                  <div
                    className={`p-2 cursor-pointer rounded-full ${
                      bookingData.student_athlete ? 'bg-yellow-500' : 'bg-gray-200'
                    }`}
                ...
                {guideInfo?.paid_internship && (
                  <div
                    className={`p-2 cursor-pointer rounded-full ${
                      bookingData.paid_internship ? 'bg-yellow-500' : 'bg-gray-200'
                    }`}
