...
const BookGuide = () => {
  ...
  useEffect(() => {
    const fetchGuideInfo = async () => {
      ...
      try {
        const response = await axios.post('https://dhvxzt123j.execute-api.us-east-2.amazonaws.com/api/guideInfo', { email });
  ...
  const handleBookingSubmit = async (e) => {
    ...
    try {
      await axios.post('https://dhvxzt123j.execute-api.us-east-2.amazonaws.com/api/sendBookingRequest', 
      { data: bookingData, 
