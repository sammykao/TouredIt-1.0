  ...
  return (
    ...
    >
      ...
      <DialogContent className="text-center">
        ...
        <Typography
          variant="body1"
          className="text-base sm:text-lg leading-relaxed my-16"
        >
          Welcome, Bespoke client! We value your support and interest in using TouredIt. Use the discount code below to enjoy a
          $25 discount on your next booking.
        </Typography>
        <Typography
          variant="h5"
          className="font-bold text-xl sm:text-2xl text-red-600 mt-10"
        >
          BESPOKECLIENT25
        </Typography>
      </DialogContent>
