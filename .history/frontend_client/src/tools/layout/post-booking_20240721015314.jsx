    ...
    <>
      <div className="relative isolate px-6 pb-20 pt-14 lg:px-8 min-h-screen bg-gray-500">
        ...
        <div className="items-center text-center m-32 justify-center px-6 pt-14">
          <h1 className="text-4xl font-bold text-black">Thanks for booking </h1>
          <br></br>
          <h4 className="text-3xl text-black"> If your guide accepts your request or a match is found,
            <br></br>they or a member of our team will reach out to your email. <br></br>
            <br></br>You should additionally get a confirmation in your email. <br></br>
            We really appreciate your support. <br></br><br></br> - TouredIt Team
          </h4>
        </div>
        <div
