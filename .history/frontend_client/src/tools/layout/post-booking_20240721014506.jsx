import {TypographyS } from "@material-tailwind/react";
  ...
  return (
    <>
      <div className="relative isolate px-6 pb-20 pt-14 lg:px-8 min-h-screen bg-gray-500">
        ...
        <div className="flex items-center m-32 justify-center px-6 pt-14">
          <Typography
          variant="h1"
          color="blue-gray"
          ...
          className="mb-4 !text-lg lg:!text-xl text-center"
          > 
          If your guide accepts your request or a match is found, they or a member of our team will reach out to your email.
          </Typography>
        </div>
        <div
