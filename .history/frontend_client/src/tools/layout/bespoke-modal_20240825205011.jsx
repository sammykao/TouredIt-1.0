...
const BespokeModal = ({ open, onClose }) => {
  return (
    <Dialog open={open} onClose={onClose} aria-labelledby="bespoke-modal-title">
      ...
      <DialogContent>
        <img src="@/../public/" alt="Bespoke Logo" style={{ width: '100%', marginBottom: '16px' }} />
        <Typography variant="body1" gutterBottom>
          Welcome, Bespoke client! We appreciate your interest in using TouredIt. Use the discount code below to enjoy a 20% discount on your next booking.
        </Typography>
