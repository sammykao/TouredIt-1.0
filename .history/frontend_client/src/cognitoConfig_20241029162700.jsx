...
export const encrypt = (text) => CryptoJS.AES.encrypt(text, import.meta.env.VITE_KEY_ENCRYPT).toString();
const decrypt = (ciphertext) => {
  const bytes = CryptoJS.AES.decrypt(ciphertext, import.meta.env.VITE_KEY_ENCRYPT);
