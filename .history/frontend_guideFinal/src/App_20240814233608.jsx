...
import UpdateWorkExperience from "@/pages/update-activities";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/update-work-experience" element={isAuthenticated() ?  <UpdateHobbies /> : <Navigate replace to="/home" />} />
