...
function App() {
  ...
  const portalPaths = ['/update-hobbies', '/tours', '/update-activities', '/profile', '/update-work-experience', '/calls']

  return (
    <>
      {!portalPaths.includes(pathname) && (
      ...
      <Routes>
        ...
        <Route path="/calls" element={isAuthenticated() ? <Calls /> : <Navigate replace to="/home" />} />
