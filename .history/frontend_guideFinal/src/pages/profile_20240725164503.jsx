...
export function Profile() {
  ...
  const handleImageUpload = async () => {
    if (selectedFile) {
      ...
      try {
        const uploadResponse = await axios.post("https://your-upload-url.com/upload", imageFormData, {
          headers: {
          ...
          <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
            {isEditing ? (
              <form className="space-y-6 sm:py-6 sm:px-6">
                ...
                <div>
                  <label htmlFor="secondary_major" className="block text-sm font-medium text-gray-700">
                    Secondary Major
                  </label>
                  <div className="mt-1">
                    <Select
                ...
                <div>
                  <label htmlFor="secondary_minor" className="block text-sm font-medium text-gray-700">
                    Secondary Minor
                  </label>
                  <div className="mt-1">
                    <Select
