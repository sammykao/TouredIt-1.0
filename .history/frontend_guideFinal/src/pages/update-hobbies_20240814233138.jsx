...
export function UpdateHobbies() {
  ...
  const deleteHobby = async (id) => {
    if (window.confirm("Are you sure you want to delete this hobby?")) {
      try {
        const response = await axios.post('http://localhost:3000/api/remHobby', { id });
            ...
            <div className="flex flex-col items-center sm:flex-row sm:items-start">
              ...
              <div className="mt-4 sm:mt-0 sm:ml-4 text-center sm:text-left">
                ...
                <div className="mt-2">
                  ...
                  <span className="mx-1 text-gray-400">•</span>
                  <Link to="/update-activities" className='hover:text-gray-500'>Update Work Experience</Link>
                  <span className="mx-1 text-gray-400">•</span>
