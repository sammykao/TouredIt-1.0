...
export function Profile() {
  ...
  const handleEditSave = async () => {
    if (selectedFile) {
      ...
      try {
        const uploadResponse = await axios.post("https://your-upload-url.com/upload", formData, {
          headers: {
        ...
        setFormData({
          ...formData,
          profile_image_url: uploadResponse.data.imageUrl
        });
      } catch (error) {
                ...
                <ul className="text-gray-700">
                  {isEditing ? (
                    <>
                      ...
                      <li className="flex border-y py-2 items-center">
                        <span className="font-bold w-72">Profile Image URL:</span>
                        <Input
                          type="text"
                      ...
                      <li className="flex border-y py-2 items-center">
                        ...
                        <span className="text-gray-700 flex-1">{responseData.guide.major}</span>
                      </li>
                      <li className="flex border-y py-2 items-center">
                        <span className="font-bold w-72">Secondary Major (if applicable):</span>
                        <span className="text-gray-700 flex-1">{responseData.guide.secondary_major}</span>
                      </li>
                      <li className="flex border-y py-2 items-center">
                        <span className="font-bold w-72">Minor (if applicable):</span>
                        <span className="text-gray-700 flex-1">{responseData.guide.minor}</span>
                      </li>
                      <li className="flex border-y py-2 items-center">
                        <span className="font-bold w-72">Secondary Minor (if applicable):</span>
                        <span className="text-gray-700 flex-1">{responseData.guide.secondary_minor}</span>
                      </li>
                      <li className="flex border-y py-2 items-center">
                    ...
                    <>
                      ...
                      <li className="flex border-y py-2">
                        <span className="font-bold w-72">Profile Image URL:</span>
                        <span className="text-gray-700">{responseData.guide.profile_image_url}</span>
                      </li>
                      <li className="flex border-y py-2">
                        <span className="font-bold w-72">Major:</span>
