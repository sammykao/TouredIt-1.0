  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const imageEndpoint = `https://zytxastigf5jf3p5qhcb472ba40icqyo.lambda-url.us-east-2.on.aws/images/${response.data.guide.profile_image_url}`;
        
        // Check the Content-Type of the image URL
        const imgresponse = await axios.get(imageEndpoint);
        console.log(imgresponse.data);
        
        setImageUrl(`data:image/jpeg;base64,${imgresponse.data}`);
      } catch (error) {
        setError(error);
      } finally {
        setLoading(false);
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0">
                  <img 
                    ...
                    src={imageUrl} 
                    alt="Profile" 
                    onError={(e) => { e.target.src = 'default--url.jpg'; }} 
                  />
                </div>
                <div className="ml-4">
