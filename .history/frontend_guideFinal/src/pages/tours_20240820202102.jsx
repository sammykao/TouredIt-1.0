          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="ml-0 md:ml-4 text-center md:text-left">
              ...
              <div className="mt-2 flex flex-col sm:flex-row sm:space-x-2">
                ...
                <Link to="/update-activities" className='bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-md text-center mb-2 sm:mb-0'>
                  Update Activities
                </Link>
                <Link to="/update-hobbies" className='bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-3 rounded-full text-center mb-2 sm:mb-0'>
                  Update Hobbies
                </Link>
