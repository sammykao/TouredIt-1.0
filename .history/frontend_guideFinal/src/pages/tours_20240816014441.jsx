                    ...
                    {pendingTours.map((tour, index) => (
                      <li key={index} className="py-4 flex space-x-3">
                        <div className="flex-1 sm:px-6">
                          ...
                          <p className="text-md text-gray-500">Any Comments: {tour.comments}</p>
                          <div className="text-md text-gray-500">
                            <Typography className='font-bold text-md text-black my-2'>Add-on Package Requests that</Typography>
