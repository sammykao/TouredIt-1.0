            ...
            <div className="mt-2 hidden sm:block">
              <Typography className="text-lg font-semibold text-gray-700 mb-4">
                <div className="flex py-2">
                  <span className="font-bold w-full sm:w-1/4 ml-2">Activities</span>
                  <span className="font-bold w-full sm:w-1/4 ml-2">Name</span>
                  <span className="font-bold w-full sm:w-1/4 ml-2">Description</span>
                </div>
              </Typography>
            </div>
            <ul className="text-gray-700">
