        ...
        <section className="lg:py-28 py-10 px-8">
            ...
            <div className="container mx-auto grid lg:gap-x-8 gap-y-8 grid-cols-1 lg:grid-cols-3">
                ...
                <CardBody className="text-center">
                    ...
                    either communicate directly with us or accept/decline the tour in your tour guide portal. You will then
                    be given all the steps and information you need to give the tour. 
                    </Typography>
                    <img
