...
export function Tours() {
  ...
  useEffect(() => {
    const fetchGuideInfo = async () => {
      try {
        const response = await axios.post("https://lera2ibwne.execute-api.us-east-2.amazonaws.com/api/retGuideInfo", { email });
    ...
    const fetchTours = async () => {
      try {
        const tourResponse = await axios.post("https://lera2ibwne.execute-api.us-east-2.amazonaws.com/api/retTours", { email });
