            ...
            <div className="mt-2">
              <Typography className="text-lg font-semibold text-gray-700 mb-4">
                <li className="flex py-2">
                  <span className="font-bold w-32 sm:w-72">Activities</span>
                  <span className="font-bold w-32 sm:w-72">Name</span>
                  <span className="font-bold w-32 sm:w-72">Description</span>
                </li>
              </Typography>
            </div>
            <ul className="text-gray-700">
              {responseData.guide.activities && responseData.guide.activities.length > 0 ? (
                responseData.guide.activities.map((activity, key) => (
                  <li key={key} className="flex flex-col sm:flex-row items-center border-y py-2">
                    <span className="font-bold w-32 sm:w-72">Activity:</span>
                    <span className="text-gray-700 w-32 sm:w-72">{activity.activity_name}</span>
                    <span className="text-gray-700 w-32 sm:w-72">{activity.description}</span>
                    <span className="font-bold w-full sm:w-1/3">Activity:</span>
                    <span className="text-gray-700 w-full sm:w-1/3">{activity.activity_name}</span>
                    <span className="text-gray-700 w-full sm:w-1/3">{activity.description}</span>
                    <button
