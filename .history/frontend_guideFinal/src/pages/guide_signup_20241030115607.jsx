...
export function GuideSignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage('Registration successful! Please check your email for the verification code. If you cannot find it, please check your spam folder.');
      setIsVerifying(true);
      setError('');
    } catch (error) {
      if (error.code === 503) {
          ...
          <div className="flex justify-center items-center mb-12">
            {!isVerifying ? (
              <ProfileForm
                  ...
                  renderMajorOptions={renderMajorOptions}
                  renderGradYearOptions={renderGradYearOptions}
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              ...
              />
                <p className="mt-6 mb-6 text-lg leading-8 text-gray-800">
                  ...
                  normally last for 90 minutes. Guides get paid $25 per call, and these calls last Please sign in to view you profile and to ensure all information is correct.
