            ...
            {!isVerifying ? (
              <form onSubmit={handleSubmit} className="w-full max-w-lg ">
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                  ...
                  Check each of these if these apply to you, but please specify more in the respective sections” to "Selecting the following options will enroll you in TouredIt's additional packaged tours. Be sure to specify your connection to these packages in the hobbies or on-campus activities section of your profile. For more details on each option, hover over the information icon associated with the package."
                  </Typography>
                  ...
                  <div className="w-full md:w-1/3 px-3 relative">
                    ...
                    <div className="inline-block relative">
                      ...
                      insights on the rushing process and Greek Life, and answering any related questions they may have. Please indicate more about your experience in Greek Life within your on-campus activities section on your profile!
                      .
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-full md:w-1/3 px-3 relative">
                    ...
                    <div className="inline-block relative">
                      ...
                      <div className="absolute bottom-full left-0 mb-2 w-48 p-2 text-sm text-white bg-gray-800 rounded-lg shadow-lg opacity-0 transition-opacity duration-300 transform -translate-y-2 scale-95 group-hover:opacity-100 group-hover:translate-y-0 group-hover:scale-100 z-10">
                        Student Athletes participate in college sports while managing academic responsibilities.
                      </div>
                    </div>
                  </div>
