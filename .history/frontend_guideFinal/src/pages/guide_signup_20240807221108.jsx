...
export function GuideSignUp() {
  ...
  const insertBackend = () => {
    ...
    try {
      ...
      axios.post('https://lera2ibwne.execute-api.us-east-2.amazonaws.com/api/newGuide', postData);

      for (const hobby of hobbyData) {
        hobby.email = email;
        axios.post('https://lera2ibwne.execute-api.us-east-2.amazonaws.com/api/newHobby', hobby);
      }

      for (const activity of activityData) {
        activity.email = email;
        axios.post('https://lera2ibwne.execute-api.us-east-2.amazonaws.com/api/newActivity', activity);
      }
