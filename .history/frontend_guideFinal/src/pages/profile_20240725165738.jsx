                    ...
                    <>
                      ...
                      <li className="flex border-y py-2 items-center">
                        ...
                        <Select
                          ...
                          onChange={(e) => handleSelectChange(e.target.value, 'major')}
                          className="text-gray-700 flex-1"
                        >
                          {renderMajorOptions()}
                        </Select>
                      ...
                      <li className="flex border-y py-2 items-center">
                        ...
                        <Select
                          ...
                          onChange={(e) => handleSelectChange(e.target.value, 'secondary_major')}
                          className="text-gray-700 flex-1"
                        >
                          {renderMajorOptions()}
                        </Select>
                      ...
                      <li className="flex border-y py-2 items-center">
                        ...
                        <Select
                          ...
                          onChange={(e) => handleSelectChange(e.target.value, 'minor')}
                          className="text-gray-700 flex-1"
                        >
                          {renderMajorOptions()}
                        </Select>
                      ...
                      <li className="flex border-y py-2 items-center">
                        ...
                        <Select
                          ...
                          onChange={(e) => handleSelectChange(e.target.value, 'secondary_minor')}
                          className="text-gray-700 flex-1"
                        >
                          {renderMajorOptions()}
                        </Select>
