...
async function postImage({ image, description }) {
  ...
  const result = await axios.post('https://zytxastigf5jf3p5qhcb472ba40icqyo.lambda-url.us-east-2.on.aws/images', formData, { headers: { 'Content-Type': 'multipart/form-data' } });
  return result.data;
}
...
export function GuideSignUp() {
  ...
  const insertBackend = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://zytxastigf5jf3p5qhcb472ba40icqyo.lambda-url.us-east-2.on.aws/sapi/newGuide', postData);
      hobbyData.email = email;
      const hobbyresponse = await axios.post('https://zytxastigf5jf3p5qhcb472ba40icqyo.lambda-url.us-east-2.on.awsapi/newHobby', hobbyData);
      activityData.email = email;
      const activityresponse = await axios.post('https://zytxastigf5jf3p5qhcb472ba40icqyo.lambda-url.us-east-2.on.awsapi/newActivity', activityData);
      return;
