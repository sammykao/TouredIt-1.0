                          ...
                          <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                            <div dangerouslySetInnerHTML={{ __html: `
                              ...
                              ${tour.paid_internship ? `
                                ...
                                You would spend an extra 30 minutes helping them learn about the internship recruitment process, how to get internships as a college student, and resume/LinkedIn review.
                              ` : ""}
                              <br>
                              ...
                              &#8226; <strong>Add-Ons:</strong> Again, if there are any package add-ons you will have to reach out manually to coordinate about what .<br><br>
