  ...
  return (
    ...
    <div className="flex flex-wrap -mx-3 mb-6">
      <Typography className="w-full text-gray-700 text-xs font-bold mb-2">
        Be sure to specify your connection to these packages in the hobbies or on-campus activities section of your profile.
        For more details on each option, hover over the information icon associated with the package.
      </Typography>
