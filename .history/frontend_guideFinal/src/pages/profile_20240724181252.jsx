...
export function Profile() {
  ...
  const handleEditSave = () => {
    const updateData = {
      ...
      secondary_major: formData.secondary_major,
      secondary_minor: formData.secondary_minor,
    };
    axios.post("https://zytxastigf5jf3p5qhcb472ba40icqyo.lambda-url.us-east-2.on.aws/api/updateGuide", updateData)
      .then(response => {
        setResponseData(response.data);
        setIsEditing(false);
      })
