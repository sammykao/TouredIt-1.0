                  ...
                  <li key={index} className="py-4 flex flex-col sm:flex-row justify-between space-y-2 sm:space-y-0">
                    <div>
                      ...
                      <div className="text-sm text-gray-500">
                        {call.greek_life && <div className='flex'><p>Greek Life Add-on</p> <p className='ml-2 text-md font-medium text-green-700'>+$25</p></div>}
                        {call.student_athlete && <div className='flex'><p>Student-Athlete Add-on</p> <p className='ml-2 text-md font-medium text-green-700'>+$25</p></div>}
                        {call.paid_internship && <div className='flex'><p>Paid Internship Add-on</p> <p className='ml-2 text-md font-medium text-green-700'>+$20</p></div>}
                      </div>
