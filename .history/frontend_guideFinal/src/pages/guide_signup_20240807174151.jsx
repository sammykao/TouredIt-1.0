...
export function GuideSignUp() {
  ...
  const validFileTypes = ['image/jpeg', 'image/png', 'image/gif']; // Add the file types you want to allow
  ...
  const insertBackend = async () => {
    ...
    try {
      ...
      setImages([result.imagePath, ...images]);
      await axios.post('https://lera2ibwne.execute-api.us-east-2.amazonaws.com/api/updateGuide', postData);
