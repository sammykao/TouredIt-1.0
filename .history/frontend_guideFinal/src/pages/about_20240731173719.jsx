        ...
        <section className="lg:py-28 py-10 px-8">
            ...
            <div className="mb-8 container mx-auto grid lg:gap-x-8 gap-y-8 grid-cols-1 lg:grid-cols-3">
                ...
                <CardBody className="text-center">
                    ...
                    alt="iphone"
                    className="w-full rounded-lg mb-16 xl:h-[370px] lg:h-[360px] lg:translate-y-8 translate-y-7 object-cover object-center"
                    />
                </CardBody>
                </Card>
                <Card
                ...
                <CardBody className="text-center">
                    ...
                    alt="laptop"
                    className="w-full mb-4 rounded-lg lg:h-[380px] md:h-[300px] h-[220px] lg:translate-y-16 translate-y-10 object-cover object-center"
                    />
                </CardBody>
                </Card>
            </div>
