        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-black">
              We empower guides from campus' across the country to provide personalized tours. Please consider joining our network of passionate guides and starting earning $$$.
            </p>
          </div>
