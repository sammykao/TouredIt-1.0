  ...
  const insertBackend = async () => {
    ...
    try {
      ...
      for (const exp of expData) {
        exp.email = email;
        await axios.post('http://localhost:3000/api/newWorkExp', exp);
      }
          ...
          <div className="flex justify-center items-center mb-12">
            {!isVerifying ? (
              <form onSubmit={handleSubmit} className="w-full max-w-lg ">
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                  <Typography className="w-full text-gray-700 text-xs font-bold mb-2">Check each of these if these apply to you, but please specify more in the respective sections</Typography>
                ...
                <div>
                  ...
                  <div className="w-full flex justify-end mt-2">
                    <Button onClick={handleWorkExpChange} className="ml-2 py-3 px-3">
                      Add Work Experience
                    </Button>
                  </div>
                </div>
