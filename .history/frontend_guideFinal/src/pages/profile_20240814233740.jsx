...
export function Profile() {
  ...
  const handleEditSave = async () => {
    ...
    if (selectedFile) {
      ...
      try {
        const uploadResponse = await axios.post("http://localhost:3000/images", fileFormData, {
          headers: {
    ...
    axios.post("http://localhost:3000/api/updateGuide", updatedFormData)
      .then(response => {
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <div className="mt-2">
                    ...
                    <span className="mx-1 text-gray-400">•</span>
                    <Link to="/update-hobbies" className='hover:text-gray-500'>Update Work Experience</Link>
                    <span className="mx-1 text-gray-400">•</span>
                ...
                <ul className="text-gray-700">
                  {isEditing ? (
                    <>
                      ...
                      <li className="flex border-y py-2 items-center">
                        <span className="font-bold w-72">Graduation Year:</span>
                        <select
                          name="grad_year"
                      ...
                      <li className="flex border-y py-2 items-center">
                        <span className="font-bold w-72">Greek Life:</span>
                        <Checkbox
                          name="greek_life"
                          label=""
                      ...
                      <li className="flex border-y py-2 items-center">
                        <span className="font-bold w-72">Student Athlete:</span>
                        <Checkbox
                      ...
                      <li className="flex border-y py-2 items-center">
                        <span className="font-bold w-72">Paid Internship:</span>
                        <Checkbox
