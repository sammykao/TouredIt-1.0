...
import { Input, Checkbox, Button, Textarea, Typography, Select, Option } from "@material-tailwind/react";
import { signUp, confirmSignUp, resendConfirmationCode } from './../cognitoConfig';
import majors from './majors.json'; // Importing the majors JSON file
