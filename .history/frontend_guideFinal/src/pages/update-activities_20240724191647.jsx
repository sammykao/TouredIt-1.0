            ...
            <div className="mt-2">
              <Typography className="text-lg font-semibold text-gray-700 mb-4">
                <div className="flex py-2">
                  <span className="font-bold flex-1 sm:flex-none sm:w-32">Activities</span>
                  <span className="font-bold flex-1 sm:flex-none sm:w-32">Name</span>
                  <span className="font-bold flex-1 sm:flex-none sm:w-32">Description</span>
                </div>
              </Typography>
            </div>
            <ul className="text-gray-700">
              {responseData.guide.activities && responseData.guide.activities.length > 0 ? (
                responseData.guide.activities.map((activity, key) => (
                  <li key={key} className="flex flex-col sm:flex-row sm:items-center border-y py-2">
                    <div className="flex-1 sm:flex-none sm:w-32">
                      <span className="font-bold">Activity:</span>
                    </div>
                    <div className="flex-1 sm:flex-none sm:w-32">
                      <span className="text-gray-700">{activity.activity_name}</span>
                    </div>
                    <div className="flex-1 sm:flex-none sm:w-32">
