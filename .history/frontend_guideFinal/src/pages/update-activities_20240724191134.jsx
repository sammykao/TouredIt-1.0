            ...
            <div className="mt-2">
              <Typography className="text-lg font-semibold text-gray-700 mb-4">
                <li className="flex flex-wrap py-2">
                  ...
                  <span className="font-bold w-full sm:w-1/3">Name</span>
                  <span className="font-bold w-full sm:w-1/3">Description</span>
                </li>
              </Typography>
            </div>
            <ul className="text-gray-700">
              {responseData.guide.activities && responseData.guide.activities.length > 0 ? (
                responseData.guide.activities.map((activity, key) => (
                  <li key={key} className="flex flex-wrap items-center border-y py-2">
                    <span className="font-bold w-full sm:w-1/3">Activity:</span>
                    ...
                    <button
                      ...
                      className="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-3 rounded mt-2 sm:mt-0 sm:ml-4 w-full sm:w-auto"
                    >
                      Delete
                    </button>
                  </li>
