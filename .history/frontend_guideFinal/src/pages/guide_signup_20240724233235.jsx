                ...
                {!isChecked && 
                  <div className="mx-auto p-4 mb-20">
                    <div className="pdf-viewer-container h-60">
                      <object data="./../../assets/terms.pdf" type="application/pdf" width="100%" height="100%">
                        <p>Your browser does not support PDFs. <a href="./../../assets/terms.pdf">Download the PDF</a>.</p>
                      </object>
                    </div>
                  </div>
                }
          ...
          <div className="py-24 mt-12 sm:py-32 mb-5">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl lg:text-center">
                ...
                <img
                src="./../../assets/img/verificationCheck.png"
