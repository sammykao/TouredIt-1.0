    ...
    <>
      <div className="relative isolate px-6 pt-14 lg:px-8 min-h-screen pb-24 bg-gray-100">
        ...
        <div className="relative isolate overflow-hidden mt-40 bg-gray-900 py-24 sm:py-32">
            <img
                alt=""
                src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=2370&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 text-black">
                ...
                <h2 className="text-4xl font-bold tracking-tight text-black sm:text-6xl">Join TouredIt</h2>
