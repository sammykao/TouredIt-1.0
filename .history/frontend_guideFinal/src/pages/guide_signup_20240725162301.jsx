...
export function Profile() {
  ...
  const handleEditSave = async () => {
    if (selectedFile) {
      ...
      try {
        const uploadResponse = await axios.post("https://zytxastigf5jf3p5qhcb472ba40icqyo.lambda-url.us-east-2.on.aws/upload", fileData, {
          headers: {
                    ...
                    <>
                      ...
                      <li className="flex border-y py-2 items-center">
                        ...
                        <select
                          ...
                          className="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                        >
                          <option value="">Select a secondary major</option>
                          {renderMajorOptions()}
                        </select>
                      </li>
                      <li className="flex border-y py-2 items-center">
                        ...
                        <select
                          ...
                          className="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                        >
                          <option value="">Select a secondary minor</option>
                          {renderMajorOptions()}
                        </select>
                      </li>
                      <li className="flex border-y py-2 items-center">
