                    ...
                    <>
                      ...
                      <li className="flex border-y py-2 items-center">
                        ...
                        <Select
                          ...
                          onChange={(e) => handleSelectChange(e, 'major')}
                          className="text-gray-700 flex-1"
                        >
                          {renderMajorOptions()}
                        </Select>
                      ...
                      <li className="flex border-y py-2 items-center">
                        ...
                        <Select
                          ...
                          onChange={(e) => handleSelectChange(e, 'secondary_major')}
                          className="text-gray-700 flex-1"
                        >
                          {renderMajorOptions()}
                        </Select>
                      ...
                      <li className="flex border-y py-2 items-center">
                        ...
                        <Select
                          ...
                          onChange={(e) => handleSelectChange(e, 'minor')}
                          className="text-gray-700 flex-1"
                        >
                          {renderMajorOptions()}
                        </Select>
                      ...
                      <li className="flex border-y py-2 items-center">
                        ...
                        <Select
                          ...
                          onChange={(e) => handleSelectChange(e, 'secondary_minor')}
                          className="text-gray-700 flex-1"
                        >
                          {renderMajorOptions()}
                        </Select>
