...
export function FormValidation(postData) {
...
const SchoolSelect = ({ selectedSchool, setSelectedSchool, handleInputChange }) => {
  ...
  const handleSchoolSelect = (aSchool) => {
    ...
    handleInputChange({ target: { name: 'school', value: aSchool } });
    setFilteredSchools([]);
  };
...
const function SchoolSelect = ({ selectedSchool, setSelectedSchool, handleInputChange }) => {
  const [schools, setSchools] = useState([]);
  const [filteredSchools, setFilteredSchools] = useState([]);
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState(null);
