              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start">
                ...
                <div className="sm:ml-4 text-center sm:text-left">
                  ...
                  <div className="mt-2 flex flex-col sm:flex-row sm:space-x-2">
                    ...
                    <Link to="/tours" className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded-md text-center'>
                      Tours
                    </Link>
                  </div>
                </div>
            ...
            <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-md p-4 sm:p-8">
              ...
              <div>
                <ul className="text-gray-700 space-y-4">
                  {isEditing ? (
                    <>
                      <li className="flex flex-col bg-gray-400 sm:flex-row items-center">
