...
export function Tours() {
  ...
  const handleConfirm = async (id) => {
    try {
      await axios.post("https://zytxastigf5jf3p5qhcb472ba40icqyo.lambda-url.us-east-2.on.aws/api/confirmTour", { id });
  ...
  const handleCancel = async (id) => {
    try {
      await axios.post("https://zytxastigf5jf3p5qhcb472ba40icqyo.lambda-url.us-east-2.on.aws/api/cancelTour", { id });
      setRefresh(!refresh); // Trigger data refresh
    } catch (error) {
      setError(error);
    }
