                        ...
                        <>
                          ...
                          <DisclosurePanel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                            <div dangerouslySetInnerHTML={{ __html: 
                                ...
                                &#8226; <strong> Call Date: </strong> ${call.event_date}<br>\t\t
                                &#8226; <strong> Call comments: </strong> ${insertResult.rows[0].comments}<br>\t\t
                                &#8226; TouredIt Video Call Link: We sent this in to your email, please check.<br><br> 
                                <br><br>
                                ...
                                &#8226; <strong> Date and School:</strong>"I'm excited to talk to you or your child about ${call.school} on ${call.event_date}."<br>\t\t\t
