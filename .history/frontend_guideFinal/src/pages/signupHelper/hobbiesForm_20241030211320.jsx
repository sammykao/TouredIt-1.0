    ...
    return (
        <>
            <form onSubmit={handleActivitiesSubmit} className="space-y-8 mx-auto max-w-2xl px-4 sm:px-8">
                ...
                <h5 className="text-xl font-semibold text-center mb-6 text-blue-800">These will show up on your profile card</h5>
                {/* Hobbies Section */}
                ...
                <Button type="submit" className="mt-8 w-full bg-green-500 hover:bg-green-700 text-white">Submit Activities</Button>
            </form>
        </>
    );
};
