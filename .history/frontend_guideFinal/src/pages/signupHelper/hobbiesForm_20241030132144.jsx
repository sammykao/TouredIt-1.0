        ...
        <>
            <form onSubmit={handleActivitiesSubmit} className="space-y-8 mx-auto max-w-2xl px-4 sm:px-8">
                ...
                <div className="space-y-4">
                    ...
                    <Button onClick={handleAddHobby} className="mt-4 bg-blue-500 hover:bg-blue-700 w-full sm:w-auto">Add Hobby</Button>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <Button onClick={handleAddActivity} className="mt-4 bg-blue-500 hover:bg-blue-700 w-full sm:w-auto">Add Activity</Button>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    {expData.map((exp, index) => (
                        <div key={index} className="space-y-2">
                            <Input
                                ...
                                value={exp.exp_name}
                                onChange={(e) => handleWorkExpChange(index, e, 'exp_name')}
                                required
                                className="w-full"
                            />
                            <Textarea
                    ...
                    <Button onClick={handleAddWorkExp} className="mt-4 bg-blue-500 hover:bg-blue-700 w-full sm:w-auto">Add Experience</Button>
                </div>

                <Button type="submit" className="mt-8 w-full bg-green-500 hover:bg-green-600 text-white">Submit Activities</Button>
            </form>
        </>
    );
};
