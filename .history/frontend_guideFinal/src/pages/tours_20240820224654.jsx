                          ...
                          <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                            <div dangerouslySetInnerHTML={{ __html: `
                              ...
                              ${tour.student_athlete ? `
                                ...
                                You would spend an extra 30 minutes helping them learn about the recruiting process, balancing academics and athletics, 
                                and even see athlete facilities. <strong>+$20</strong>
                              ` : ""}
                              ...
                              ${tour.paid_internship ? `
                                ...
                                college student, and resume/LinkedIn review. <strong>+$20</strong>
                              ` : ""}
                              <br>
