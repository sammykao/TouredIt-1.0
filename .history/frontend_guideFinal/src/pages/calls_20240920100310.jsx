...
export function Calls() {
  ...
  const handleConfirm = async (id) => {
    try {
      ...
      const confirmedCall = pendingCalls.find(tour => tour.id === id);
                        ...
                        <>
                          ...
                          <DisclosurePanel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                            <div dangerouslySetInnerHTML={{ __html: `
                              ...
                              &#8226; <strong>Call Date:</strong> ${tour.date}<br>
                              &#8226; <strong>Call comments:</strong> ${tour.comments || "No comments provided"}<br>
