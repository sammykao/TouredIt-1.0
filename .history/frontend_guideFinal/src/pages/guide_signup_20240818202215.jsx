          ...
          <div className="flex justify-center items-center mb-12">
            {!isVerifying ? (
              <form onSubmit={handleSubmit} className="w-full max-w-lg ">
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                  <Typography className="w-full text-gray-700 text-md font-bold mb-2">
                  ...
                  <div className="w-full md:w-1/3 px-3 relative">
                    ...
                    <div className="inline-block relative">
                      ...
                      <div className="absolute bottom-full left-0 mb-2 w-48 p-2 text-sm text-white bg-gray-800 rounded-lg shadow-lg opacity-0 transition-opacity duration-300 transform -translate-y-2 scale-95 group-hover:opacity-100 group-hover:translate-y-0 group-hover:scale-100 z-10">
                      To opt into this package, you must have completed a paid internship. This package offers an additional $20 and requires an extra 30 
                      minutes beyond the standard tour. You will be responsible for talking extensively about your internship and how you achieved it. 
                      This includes giving insights into the recruiting process, how to get set up in the field you are pursuing, and any tips to get started 
                      with Freshman year classes. Please indicate more about your paid internship within your work experience section on your profile!
                      </div>
                    </div>
                  </div>
                </div>
