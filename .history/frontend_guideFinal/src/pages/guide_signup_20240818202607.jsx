            ...
            {!isVerifying ? (
              <form onSubmit={handleSubmit} className="w-full max-w-lg ">
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                  ...
                  Selecting the following options will enroll you in TouredIt's additional packaged tours. Be sure to specify your connection to these packages in the hobbies or on-campus activities section of your profile. For more details on each option, hover over the information icon associated with the package.
                  </Typography>
                  ...
                  <div className="w-full md:w-1/3 px-3">
                    ...
                    />
                    <span data-tip data-for="greekLifeTooltip" className="text-blue-500 cursor-pointer">
                      ℹ️
                    </span>
                    <ReactTooltip id="greekLifeTooltip" place="top" effect="solid">
                  ...
                  <div className="w-full md:w-1/3 px-3">
                    <Checkbox
                      ...
                      onChange={handleCheckboxChange}
                    />
                    <span data-tip data-for="studentAthleteTooltip" className="text-blue-500 cursor-pointer">
                      ℹ️
                    </span>
                    <ReactTooltip id="studentAthleteTooltip" place="top" effect="solid">
                  ...
                  <div className="w-full md:w-1/3 px-3">
                    <Checkbox
                      ...
                      onChange={handleCheckboxChange}
                    />
                    <span data-tip data-for="paidInternshipTooltip" className="text-blue-500 cursor-pointer">
                      ℹ️
                    </span>
                    <ReactTooltip id="paidInternshipTooltip" place="top" effect="solid">
