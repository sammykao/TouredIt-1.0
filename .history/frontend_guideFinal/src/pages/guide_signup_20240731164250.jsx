                ...
                <div>
                  {hobbyData.map((hobby, index) => (
                    <div key={index} className="flex flex-wrap -mx-3 mb-6">
                      ...
                      <Button className="mt-4" color="red" onClick={() => handleRemoveHobby(index)}>
                        Remove Hobby
                      </Button>
                    </div>
                  ))}
                  <Button className="mt-4" onClick={handleAddHobby}>
                    Add Hobby
                  </Button>
                </div>
                ...
                <div>
                  {activityData.map((activity, index) => (
                    <div key={index} className="flex flex-wrap -mx-3 mb-6">
                      ...
                      <Button className="mt-4" color="red" onClick={() => handleRemoveActivity(index)}>
                        Remove Activity
                      </Button>
                    </div>
                  ))}
