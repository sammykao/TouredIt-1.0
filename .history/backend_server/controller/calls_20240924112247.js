...
const createDailyRoom = async (eventDate) => {
    ...
    if (isNaN(eventDateObj.getTime())) {
        throw new Error('Invalid event date format. Please provide a valid date in "YYYY-MM-DD" format.');
    }
    ...
    try {
        ...
        return `https://www.touredit.com/video?code=${response.data.name}`;  // Adjust this to your website URL
    } catch (error) {
...
exports.sendCustomCall = async (req, res) => {
    try {
        ...
        let mailOptions = {
            ...
            Thank you for submitting a request for a video chat. Our team moves very 
            quickly and will make sure that the requested student responds soon. 
            As a reminder, our video chats are 45 minutes long and cost $50.
            <br><br>
            Warmly,<br>
            TouredIt Team
            </p>`
...
exports.sendCall = async (req, res) => {
    try {
        ...
        let mailOptions = {
            ...
            Thank you for submitting a request for a video chat. Our team moves 
            very quickly and will make sure that the requested student responds 
            soon. As a reminder, our video chats are 45 minutes long and cost $50.
        ...
        mailOptions = {
            ...
            html: `<p>Hi there!<br><br>
            Congratulations! You have a new 45-minute video chat request through TouredIt.
...
exports.confirmGuideCall = async (req, res) => {
    try {
        ...
        mailOptions = {
            ...
            <br><br><br>
            Students receive $25 for a 45 minute video call, and we offer various payment methods (Venmo, Zelle, etc.). 
