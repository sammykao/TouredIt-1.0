...
exports.sendtour = async (req, res) => {
    try {
        ...
        if (data.student_athlete) {
            ...
            You would spend an extra 30 minutes helpin them learn about the recruiting process, balancing academics and athletics, and potentially even see athlete exclusive \
