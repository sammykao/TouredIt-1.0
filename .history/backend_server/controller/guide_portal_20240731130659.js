...
exports.deleteTour = async (req, res) => {
    try {
        ...
        let mailOptions = {
            ...
            html: `<p>Hey ${clientResult.rows[0].name}<br><br>
            Unfortunately, your tour guide, ${guideResult.rows[0].name}, is unable to show you around for your tour at ${guideResult.rows[0].school}.
            oshua Bernstein will be in touch soon, though, and we assure you that we are working hard on finding you a very similar match to show you around [insert school]!
            Warm regards,<br>
            <strong>TouredIt Team</strong>
            </p>`
        };
