...
exports.sendtour = async (req, res) => {
    try {
        ...
        let additionalText = "";
        if (data.greek_life) {
            additionalText += "<br><br>You opted into the greek life package for an extra $40, we'll add that to the request.";
        }
        if (data.student_athlete) {
            additionalText += "<br><br>You opted into the student athlete package for an extra $40, we'll add that to the request.";
        }
        if (data.paid_internship) {
