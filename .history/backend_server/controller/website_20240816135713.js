...
exports.sendtour = async (req, res) => {
    try {
        ...
        mailOptions = {
            ...
            details. If you accept, you'll receive an email with the next steps. Then, our team will confirm with both 
            parties about the details of the tour and how much to pay you.<br><br>
            Warm regards,<br>
            <strong>TouredIt Team</strong>
            </p>`
        };
