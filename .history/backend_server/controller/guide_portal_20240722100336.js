...
exports.confirmTour = async (req, res) => {
    try {
        ...
        mailOptions = {
            ...
            - <strong> Date and School:<strong>"I'm excited to show you around ${guideResult.row[0].school} on ${data.date}."<br>\t\t\t
            - <strong> Major and Interests:</strong> Share your major, any notable clubs, or activities you participate in that might interest them.
            - <st
            - <strong> Meeting Point: Suggest a convenient meeting point on campus.
Special Requests: Ask if there are any specific buildings or parts of campus they would like to see in particular.
Example text: "Hi [Client's first name], my name is __ and I'm excited to show you around ${guideResult.row[0].school} on ${data.date}. I'm a [Your Major] major and I'm involved in [Clubs/Activities]. Let's meet at [Suggested Meeting Point]. Are there any specific buildings or parts of campus you'd like to see?"
