...
exports.confirmTour = async (req, res) => {
    try {
        ...
        // data should be dict or json with date field and tour
        ...
        mailOptions = {
            ...
            \t 
            \t 2. <strong> Introduce yourself via text </strong><br>\t\t
            - Start by sending a text to {introducing yoursel. Here's a script to help you:
