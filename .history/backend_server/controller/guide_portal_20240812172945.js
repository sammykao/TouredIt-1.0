...
exports.cancelTour = async (req, res) => {
    try {
        ...
        let additionalText = "";
        if (data.greek_life) {
            additionalText += "<br><br>They also opted into the <strong> greek life </strong> package for an extra $20, we'll add that to the request.";
        }
        if (data.student_athlete) {
            additionalText += "<br><br>You also opted into the <strong> student athlete </strong>package for an extra $20, we'll add that to the request.";
        }
        if (data.paid_internship) {
            additionalText += "<br><br>You opted into the <strong> paid internship chat </strong> package for an extra $20, we'll add that to the request.";
        }
        // Send email to Josh
        mailOptions = {
            from: process.env.EMAIL_USERNAME,
