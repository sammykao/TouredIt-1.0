...
exports.sendtour = async (req, res) => {
    try {
        ...
        if (data.student_athlete) {
            ...
            you would spend an extra 30 minutes learning about the recruiting process, balancing academics and athletics, and potentially even see athlete exclusive facilities (Guide's Choice).";
        }
        if (data.paid_internship) {
            additionalText += "<br><br>You also opted into the <strong> internship insights </strong> add-on package for an extra $50, we'll add that to the request.";
        }
