...
exports.confirmTour = async (req, res) => {
    try {
        ...
        mailOptions = {
            ...
            - <strong> Date and School:<strong>"I'm excited to show you or your child around ${guideResult.row[0].school} on ${tourResult.rows[0].date}."<br>\t\t\t
        ...
        mailOptions = {
            ...
            on ${tourResult.rows[0].date} for ${guideResult.row[0].school}.<br><br>
...
exports.deleteTour = async (req, res) => {
    try {
        ...
        let mailOptions = {
            ...
            on ${tourResult.date}. A member of our team will reach out to make sure you have a new match for that date.<br><br>
            Warmly,<br>
            <strong>TouredIt Team</strong>
            </p>`
        };
