...
exports.sendtour = async (req, res) => {
    try {
        ...
        if (data.paid_internship) {
            ...
            You would spend an extra 30 minutes helping them learn about the internship recruitment process, how to get internships as a college student, and resume/linkedIn ";
        }
