...
exports.confirmTour = async (req, res) => {
    try {
        ...
        mailOptions = {
            ...
            \t${guideResult.row[0].name} has accepted your tour request from ${clientResult.row[0].name}
...
exports.deleteTour = async (req, res) => {
    try {
        ...
        mailOptions = {
            ...
            If you know anybody that could possibly give a tour like this on your campus respond to this email or text 305-206-7966 for a quicker response.
            Thank you for your dedication and enthusiasm!<br><br>
            Warmly,<br>
            <strong>TouredIt Team<strong>
            </p>`
