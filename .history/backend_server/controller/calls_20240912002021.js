...
// Example usage of the generateZoomVideoSDKToken function:
try {
    const token = generateZoomVideoSDKToken("10/20/2024"); // Provide the event date in 'MM/DD/YYYY' format
...
exports.confirmGuideCall = async (req, res) => {
    try {
        ...
        const videoSession = await createZoomVideoSession();
