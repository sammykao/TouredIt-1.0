...
exports.confirmGuideCall = async (req, res) => {
    try {
        ...
        const zoomLink = await createZoomMeeting(clientResult.rows[0].email, guideResult.rows[0].email);
...
const createZoomMeeting = async (client_email, guide_email) => {
    try {
        ...
        const response = await axios.post(
            'https://api.zoom.us/v2/users/me/meetings',
            {
                ...
                settings: {
                    ...
                    alternative_hosts: `${client_email}, ${guide_email}`
                }
            },
            {
                headers: {
