...
exports.retrieveTours = async (req, res) => {
    try {
        ...
        const query = `
            SELECT
                t.event_date AS date, t.school, c.name AS guide, 
                t.confirmed, t.id AS id, t.greek_life, 
                t.student_athlete, t.paid_internship
            FROM
                tours t
            INNER JOIN
        ...
        if (result.rows.length === 0) {
            res.status(200).json({ message: 'No tours found for the specified client' });
        } else {
...
exports.confirmTour = async (req, res) => {
    try {
        ...
        let additionalText = "";
        if (data.greek_life) {
            additionalText += "<br><br>The client also requested the <strong> greek life experience</strong> add-on package, that would pay you another $30 (if you are willing). \
            You would spend an extra 30 minutes helping them learn about the greek life on campus, the rush process, and potentially even see your respective frat or sorority \
            house(s) (Your Choice).";
        }
        if (data.student_athlete) {
            additionalText += "<br><br>The client also requested the <strong> student athlete life</strong> add-on package, that would pay you another $30 (if you are willing). \
            You would spend an extra 30 minutes helping them learn about the recruiting process, balancing academics and athletics, and potentially even see athlete exclusive \
            facilities (Your Choice).";
        }
        if (data.paid_internship) {
            additionalText += "<br><br>The client also opted into the <strong> internship insights </strong> add-on package, that would pay you another $30 (if you are willing). \
            You would spend an extra 30 minutes helping them learn about the internship recruitment process, how to get internships as a college student, and ask any tips for \
            resume content or extra-curricular activities.";
        }
        ...
        mailOptions = {
            ...
            ${additionalText}<br> If they requested any additional packages, you will have to reach out manually and let them know what 
            you are willing to do. We will confirm with both parties if there are any additional packages to add to your pay.
            <br><br>
            ...
            &#8226; <strong> Packages: </strong>Again, if any additional packages are requested, you will have to let them know
            what you're willing to do and what you aren't. You get paid more for the packages, but it is totally up to you.
            If the client wants to cancel the tour due to declining a package, you will have to do it for them in the portal.<br><br><br>
...
exports.deleteTour = async (req, res) => {
    try {
        ...
        let additionalText = "";
        if (data.greek_life) {
            additionalText += "<br><br>The client also opted into the <strong> greek life </strong> package for an extra $20.";
        }
        if (data.student_athlete) {
            additionalText += "<br><br>The client also opted into the <strong> student athlete </strong>package for an extra $20.";
        }
        if (data.paid_internship) {
            additionalText += "<br><br>The client also opted into the <strong> paid internship chat </strong> package for an extra $20.";
        }
        // Send email to Josh
        mailOptions = {
            from: process.env.EMAIL_USERNAME,
...
exports.cancelTour = async (req, res) => {
    try {
        ...
        let additionalText = "";
        if (data.greek_life) {
            additionalText += "<br><br>They also opted into the <strong> greek life </strong> package for an extra $20.";
        }
        if (data.student_athlete) {
            additionalText += "<br><br>They also opted into the <strong> student athlete </strong>package for an extra $20.";
        }
        if (data.paid_internship) {
            additionalText += "<br><br>They also opted into the <strong> paid internship chat </strong> package for an extra $20.";
        }
        // Send email to Josh
        mailOptions = {
            from: process.env.EMAIL_USERNAME,
