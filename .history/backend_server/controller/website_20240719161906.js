...
exports.sendtour = async (req, res) => {
    try {
        ...
        mailOptions = {
            ...
            html: "<p> Hi! \n\n\tYou have a new guide request. \
            Please visit your tour guide portal to accept or decline \
            the new request, as well as see the next steps. \
            We appreciate your support and if you ever need anything (like cancellations), \
            email us at info@touredit.com.\n\nWarmly,\nTouredIt Team\n \
            </p>"
                
        };
    
        transporter.sendMail(mailOptions, function (err, inf    o) {
            if (err) {
                console.log(err);
            }
        });
        // Query to get the tours for the specific client including the tour guide's name and confirmation status
        { confirmedTours, nonConfirmedTours });
        }
