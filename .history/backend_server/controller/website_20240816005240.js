...
exports.sendtour = async (req, res) => {
    try {
        ...
        if (data.paid_internship) {
            ...
            You would spend an extra 30 minutes helping them learn about the internship recruitment process, how to get internships as a college student, and ask any tips for resume content or extra-curricular activities.";
        }
        ...
        mailOptions = {
            ...
            requests that you will be paid extra for. <br> <br> Once you're in the portal, you'll see the tour 
