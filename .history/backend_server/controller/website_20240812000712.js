...
exports.sendcustomtour = async (req, res) => {
    try {
        ...
        if (data.student_athlete) {
            additionalText += "<br><>As a student-athlete, we’ll match you with a guide who understands balancing academics and athletics.";
        }
        if (data.paid_internship) {
            additionalText += "<br><br>Your interest in paid internships has been noted. We’ll make sure to find someone who can provide you with the necessary guidance.";
        }
...
exports.sendtour = async (req, res) => {
    try {
        ...
        let additionalText = "";
        if (data.greek_life) {
            additionalText += "<br><br>We noticed you're interested in Greek life. We'll ensure your tour guide has relevant insights.";
        }
        if (data.student_athlete) {
            additionalText += "<br><br>As a student-athlete, we’ll match you with a guide who understands balancing academics and athletics.";
        }
        if (data.paid_internship) {
            additionalText += "<br><br>Your interest in paid internships has been noted. We’ll make sure to find someone who can provide you with the necessary guidance.";
        }
        ...
        let mailOptions = {
            ...
            email us at info@touredit.com. <br><br>
            Warmly,<br>
            <strong>TouredIt Team</strong>${additionalText}
            </p>`
        };
