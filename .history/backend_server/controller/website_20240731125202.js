...
exports.sendtour = async (req, res) => {
    try {
        ...
        let mailOptions = {
            ...
            and will make sure a match is found, or that the requested guide responds soon. 
            We appreciate your support and if you ever need anything or have any questions (including a cancellation), email us at info@touredit.com.
            Warmly,<br>
