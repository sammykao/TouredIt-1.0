...
exports.updateGuideAccounts = async (req, res) => {
    try {
        ...
        const query = `
            ...
            RETURNING *`;
        const values = [account.name, account.email, account.school, account.hometown, 
            account.phone, account.bio, account.major, account.secondary_major, account.minor, account.secondary_minor, account.profile_image_url, account.instagram, account.linkedin];
