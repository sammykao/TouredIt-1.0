...
exports.sendtour = async (req, res) => {
    try {
        ...
        mailOptions = {
            ...
            such as work experience chats or greek life bonuses, you will let the client know
            what you're willing to do after you accept. Then we will confirm with both parties
