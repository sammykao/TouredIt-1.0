...
exports.sendtour = async (req, res) => {
    try {
        ...
        additionalText = "";
        if (data.greek_life) {
            additionalText += "<br><br>The client also requested the <strong> greek life experience</strong> add-on package, that would pay you another $25 (if you are willing). \
