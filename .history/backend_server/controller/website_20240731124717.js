...
// sending email
xports.sendEmail = async (req, res) => {
...
exports.sendtour = async (req, res) => {
    try {
        ...
        mailOptions = {
            ...
            to accept or decline the request. Once you're in the portal, you'll see the tour details. If you accept, you'll receive an email with the next steps.
            Warm regards,
            <strong>TouredIt Team</strong>
            </p>`
        };
        "Hi there!
Congratulations! You have a new tour guide request through TouredIt. Please visit your tour guide portal at https://www.toureditguides.com/sign-in to accept or decline the request.
Once you're in the portal, you'll see the tour details. If you accept, you'll receive an email with the next steps.
Warm regards,
TouredIt Team"
