...
exports.sendtour = async (req, res) => {
    try {
        ...
        if (data.student_athlete) {
            additionalText += "<br><br>The also requested the <strong> student athlete life</strong> add-on package, that would pay you another $30 (if you are willing). \
        ...
        mailOptions = {
            ...
            the campus tour itself. Then we will confirm with both parties about the details of the tour and how much to pay you.<br><br>
            Warm regards,<br>
            <strong>TouredIt Team</strong>
            </p>`
        };
