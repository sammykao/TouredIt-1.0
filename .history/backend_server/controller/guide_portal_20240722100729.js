...
exports.confirmTour = async (req, res) => {
    try {
        ...
        mailOptions = {
            ...
            for the date or any other date, email info@touredit.com and we can cancel the tour.
            - <strong> Meeting Point:</strong> Suggest a convenient meeting point on campus.
