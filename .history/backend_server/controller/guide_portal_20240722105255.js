...
exports.confirmTour = async (req, res) => {
    try {
        ...
        let mailOptions = {
            ...
            \t${guideName} has accepted your tour request for ${guideSchool}
        ...
        mailOptions = {
            ...
            - <strong> Client name:</strong> ${clientName} (Can be either parent/adult or student)<br>\t\t
            ...
            - <strong> Your Name:<strong> "Hi, ${clientName} my name is __."<br>\t\t\t
        ...
        mailOptions = {
            ...
            \t${guideResult.row[0].name} has accepted a tour request from ${clientName}
...
exports.deleteTour = async (req, res) => {
    try {
        ...
        mailOptions = {
            ...
            html: `<p>Hi Josh,<br><br>
            \t${guideResult.row[0].name} has declined a tour request from ${clientName}
            on ${data.date} for ${guideResult.row[0].school}.<br><br>
            \t - <strong> The client and tour details </strong><br>\t\t
            - <strong> Client name:</strong> ${clientName}<br>\t\t
            - <strong> Client email:</strong> ${email}<br>\t\t
