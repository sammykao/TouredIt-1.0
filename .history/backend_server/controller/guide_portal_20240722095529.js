...
exports.confirmTour = async (req, res) => {
    try {
        ...
        mailOptions = {
            ...
            successful tour experience:?You have a new guide request. <br><br>
            \t 1. <strong> Introduce yourself via text </strong><br>\t\t
            - Start by sending a text to [Client's Name] introducing yourself. Here's a script to help you:
Your Name: "Hi, my name is [Tour Guide's Name]."
Date and School: "I'm excited to show you around [School Name] on [Date of Tour]."
Major and Interests: Share your major, any notable clubs, or activities you participate in that might interest them.
Meeting Point: Suggest a convenient meeting point on campus.
Special Requests: Ask if there are any specific buildings or parts of campus they would like to see in particular.
Example text: "Hi [Client's Name], my name is [Tour Guide's Name] and I'm excited to show you around [School Name] on [Date of Tour]. I'm a [Your Major] major and I'm involved in [Clubs/Activities]. Let's meet at [Suggested Meeting Point]. Are there any specific buildings or parts of campus you'd like to see?"
