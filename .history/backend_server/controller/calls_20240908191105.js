...
// Authorize using Google Calendar API
...
// Create a Google Meet link without time
async function createGoogleMeetLink(authClient, attendeeEmail) {
    ...
    const response = await calendar.events.insert({
        calendarId: 'primary',
        resource: event,
        conferenceDataVersion: 1, // This enables the creation of a Meet link
    });
