...
exports.sendtour = async (req, res) => {
    try {
        ...
        additionalText = "";
        if (data.greek_life) {
            additionalText += "<br><br>The client also requested the <strong> greek life experience</strong> add-on package, that would pay you another $30 (if you are willing). Learn about the greek life on campus, the rush process, and potentially even see the guide's respective frat or sorority house(s) (Guide's Choice).
