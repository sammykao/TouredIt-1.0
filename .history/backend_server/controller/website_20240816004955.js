...
exports.sendtour = async (req, res) => {
    try {
        ...
        if (data.greek_life) {
            ...
            You would spent an extra 30 minutes helping them learn about the greek life on campus, the rush process, and potentially even see the 's respective frat or sorority house(s) (Guide's Choice).";
        }
        if (data.student_athlete) {
            additionalText += "<br><br>You also requested the <strong> student athlete life</strong> add-on package for an extra $50, we'll add that to the request.";
        }
