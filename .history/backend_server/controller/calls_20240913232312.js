...
const createDailyRoom = async (eventDate) => {
    ...
    const roomName = `TouredIt_Video_Session_${uuidv4()}`;
    ...
    const options = {
        ...
        data: {
            ...
            properties: {
                enable_prejoin_ui: true,   // Enable pre-join UI for users to enter their names
                enable_people_ui: true,  
                hide_daily_branding: true,   // Show participant names in UI
    ...
    try {
        ...
        return {
            roomUrl: `https://your-website.com/video?room=${roomName}`,  // Adjust this to your website URL
            roomName,
        };
    } catch (error) {
