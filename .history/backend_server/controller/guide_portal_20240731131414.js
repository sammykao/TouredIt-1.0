...
exports.confirmTour = async (req, res) => {
    try {
        ...
        mailOptions = {
            ...
            Guides receive $40 for a 60-90 minute tour, and we offer various payment methods (Venmo, Zelle, etc.). After the tour, a member of our team will contact you via text or email to confirm the tour and arrange payment.
