...
exports.sendtour = async (req, res) => {
    try {
        ...
        additionalText = "";
        if (data.greek_life) {
            additionalText += "<br><br>They also requested the <strong> greek life experience</strong> add-on package, that would pay you another $30 (if you ) we'll add that to the request.";
        }
        if (data.student_athlete) {
            additionalText += "<br><br>You also requested the <strong> student athlete life</strong> add-on package for an extra $50, we'll add that to the request.";
        }
