...
exports.sendcustomtour = async (req, res) => {
    try {
        ...
        let mailOptions = {
            ...
            is found. We normally price tours at $150 for a 90 minute session.We appreciate your support and if you ever need anything, 
...
exports.sendtour = async (req, res) => {
    try {
        ...
        if (data.paid_internship) {
            additionalText += "<br><br>The client also opted into the <strong> internship insights </strong> add-on package fpr another $50.";
        }
        mailOptions = {
            from: process.env.EMAIL_USERNAME,
