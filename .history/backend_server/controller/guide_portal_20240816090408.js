...
exports.confirmTour = async (req, res) => {
    try {
        ...
        mailOptions = {
            ...
            ${additionalText}<br> If they requested any additional packages, you will have to reach out manually and let them know 
            if you accept them and what you are willing to do. We will confirm with both parties if there are any additional p
            ackages to add to your pay.
            <br><br>
