...
const createZoomVideoSession = async () => {
    try {
        const token = generateZoomVideoSDKToken(); // JWT Token generated

        // Optionally return sessionName for the frontend to use
        return {
            token,
            sessionName: "TouredIt_Video_Session", // Static or dynamic session name
        };
