...
exports.sendtour = async (req, res) => {
    try {
        ...
        if (data.paid_internship) {
            additionalText += "<br><br>You also opted into the <strong> internship insights </strong> add-on package for an extra $50, we'll add that to the request.";
        }
        ...
        let mailOptions = {
            ...
            tours at $140 for a 90 minute session. ${additionalText}<br><br>We appreciate your support 
        ...
        mailOptions = {
            ...
            to accept or decline the request. ${additionalText}<br><br>There you can also see any added package 
            requests that you will be paid extra for. Once you're in the portal, you'll see the tour 
            details. If you accept, you'll receive an email with the next steps. For package add-on requests,
            you will see the request and then reach out to let them know what you're willing to do after you accept
            the campus tour itself. Then we will confirm with both parties about the details of the tour and 
            how much to pay you.<br><br>
            Warm regards,<br>
            <strong>TouredIt Team</strong>
            </p>`
        };
        ...
        mailOptions = {
            from: process.env.EMAIL_USERNAME,
            to: "info@touredit.com",
            subject: "A guide got a tour request",
            html: `<p>Hi there!<br><br>
            ${guide_email} got a tour request. ${additionalText}<br><br> 
            We will need confirm with both parties about the details of the tour and 
            how much to invoice the client you.<br><br>
            Warm regards,<br>
            <strong>TouredIt Team</strong>
            </p>`
        };
