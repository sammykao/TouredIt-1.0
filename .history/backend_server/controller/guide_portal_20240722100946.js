...
exports.confirmTour = async (req, res) => {
    try {
        ...
        mailOptions = {
            ...
            - <strong> Client name:</strong> ${clientResult.row[0].name} (Can be either parent/adult or student)
            - <strong> Client email:</strong> ${clientResult.row[0].name} (Can be either parent/adult or student)
