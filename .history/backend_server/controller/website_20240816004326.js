...
exports.sendtour = async (req, res) => {
    try {
        ...
        let additionalText = "";
        if (data.greek_life) {
            additionalText += "<br><br>You also requested the <strong> greek life experience</strong> package for an extra $50, we'll add that to the request.";
        }
        if (data.student_athlete) {
            additionalText += "<br><br>You also opted into the <strong> student athlete </strong>package for an extra $50, we'll add that to the request.";
        }
        if (data.paid_internship) {
            additionalText += "<br><br>You also opted into the <strong> paid internship chat </strong> package for an extra $50, we'll add that to the request.";
        }
        ...
        mailOptions = {
            ...
            requests that you will be paid extra for. 
            <br> <br> Once you're in the portal, you'll see the tour 
