...
exports.sendCustomCall = async (req, res) => {
    try {
        ...
        let mailOptions = {
            ...
            Thank you for submitting a request for a video call. Our team moves very quickly and will make sure a match 
...
exports.sendCall = async (req, res) => {
    try {
        ...
        let mailOptions = {
            ...
            Thank you for submitting a request for a video call. Our team moves very quickly 
            and will make sure that the requested student responds soon. We normally price
            video chats at $50 for a 60 minute session. ${additionalText}<br><br>We appreciate your support 
