...
exports.sendtour = async (req, res) => {
    try {
        ...
        if (data.paid_internship) {
            ...
            Learn about the internship recruitment process, how to get internships as a college student, and ask any tips for resume content or extra-curricular activities.";
        }
