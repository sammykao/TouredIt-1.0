...
router.post('/newGuide', portal_controls.insertOrUpdateGuideAccounts);
...
router.post('/declineCall', call_controls.deleteGuideCall);
router.post('/confirmCall', call_controls.confirmGuideCall);
router.post('/cancelCall', call_controls.cancelGuideCall);
