...
async function postImage({ image }) {
  ...
  formData.append("image", compressedImg, uniqueName);
  console.log(formData);
  const result = await axios.post(
    'https://lera2ibwne.execute-api.us-east-2.amazonaws.com/images',
    formData
  );
  console.log(result);
...
export function GuideSignUp() {
  ...
  const [expData, setExpData] = useState([{ job_name: '', description: '' }]);
  ...
  const handlePostDataSubmit = async (e) => {
    ...
    try {
      ...
      console.log(postData.profile_image_url);
  ...
  if (loading) {
    return (
      <div className="relative isolate flex items-center justify-center px-6 pt-14 lg:px-8 min-h-screen pb-24">
        <div
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl lg:text-center">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-800">Tour guides make or break a tour. We are looking for enthusiastic and energetic guides who 
                  ...
                  All the info submitted in the signup form (except private data), will be displayed on your profile card on TouredIt.com
                </p>
              </div>
            </div>
          </div>
