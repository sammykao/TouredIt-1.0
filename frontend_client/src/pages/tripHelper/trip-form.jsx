    ...
    <div className="rounded-lg max-w-4xl mx-auto sm:px-6 sm:py-6 lg:px-8 lg:py-8">
      <div className="mt-4 p-4 bg-white border border-gray-300 rounded-lg sm:p-6">
        <form onSubmit={handleFormSubmit}>
                  ...
                  <>
                    <div className='border-2 p-2 rounded-lg'>
                      ...
                      <Input
                        ...
                        required
                      />
                      <Typography variant="small" className="mt-6 underline mb-2 text-left font-medium !text-gray-900 text-sm sm:text-base">
                        Date Range
                      </Typography>
                      <div className="flex space-x-4 mb-2">  {/* Flexbox container to align inputs side by side */}
          ...
          {/* Packages Section */}
          <div className="mb-4">
            <Typography variant="small" className="my-2 text-left font-medium !text-gray-900 text-sm sm:text-base">
